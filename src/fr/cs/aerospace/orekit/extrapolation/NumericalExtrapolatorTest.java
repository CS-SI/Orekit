...
public class NumericalExtrapolatorTest extends TestCase {

    public NumericalExtrapolatorTest(String name) {
    super(name);
  }
...
try {
  ...
  public static Test suite() {
    return new TestSuite(NumericalExtrapolatorTest.class);
  }
