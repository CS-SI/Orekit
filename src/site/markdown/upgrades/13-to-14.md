...
| [Added controlled loading of EOP data](#Added_controlled_loading_of_EOP_data)                                                                                          | [issue xxxx](https://gitlab.orekit.org/orekit/orekit/-/work_items/xxxx)                                                                          |
...
If users implemented the `EopHistoryLoader` interface in custom classes, they must adapt their implementations
to the new `fillHistory` method signature.
