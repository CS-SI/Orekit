...
drag coefficients their default names are the concatenation of `IsotropicDragBuilder.SPAN_PREFIX`,
`DragSensitive.DRAG_COEFFICIENT`, and an index counting from 1. Of course, these names can be changed using
`ParameterDriver.setName()`.
