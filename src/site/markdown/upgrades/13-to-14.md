...
`CommonGnssData` class are now defined in the `GNSSOrbitalElementsFactory` concrete class (and new constants
`A_DOT`, `DELTA_N0_DOT`,…  have been added to support all messages parameters).
