...
parsing will be slightly off as the corresponding double is not representable in IEEE754. The
...
as looking at the values shows these slopes were in fact simple numbers (only different three
