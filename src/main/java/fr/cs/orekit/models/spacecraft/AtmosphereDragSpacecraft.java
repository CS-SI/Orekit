 ...
 *
 * @see fr.cs.orekit.propagation.forces.perturbations.AtmosphericDrag
 * @author F. Maussion
 */
public interface AtmosphereDragSpacecraft {

    /** Get the visible surface from a specific direction.
     * See {@link fr.cs.orekit.propagation.forces.perturbations.AtmosphericDrag} for more explanations.
