...
public class IodGibbs {
    ...
    public KeplerianOrbit estimate(final Frame frame,
                                   final PV pv1, final PV pv2, final PV pv3) {
     ...
     *
     * @param frame measure frame
     * @param r1   PV measure 1 taken in frame
     * @param date1 date of measure 1
     * @param r2   PV measure 2 taken in frame
     * @param date2 date of measure 2
     * @param r3   PV measure 3 taken in frame
    ...
    public KeplerianOrbit estimate(final Frame frame,
        ...
        final Vector3D D = r1.crossProduct(r2).add(
                                                    r2.crossProduct(r3).add(
                                                                            r3.crossProduct(r1)));
