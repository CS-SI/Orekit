...
/**
 * Abstract class for signal-based measurement model.
 * @since 14.0
 * @author Romain Serra
 */
public abstract class AbstractSignalBasedModel {
     ...
     */
    protected AbstractSignalBasedModel(final SignalTravelTimeModel signalTravelTimeModel) {
