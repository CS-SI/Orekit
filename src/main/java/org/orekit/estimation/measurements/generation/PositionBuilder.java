...
public class PositionBuilder extends AbstractMeasurementBuilder<Position> {
     ...
     */
    public PositionBuilder(final double sigma, final double baseWeight,
                           final ObservableSatellite satellite) {
        this(new MeasurementQuality(new double[] {sigma, sigma, sigma}, baseWeight), satellite);
    }
     ...
     * @since 14.0
     */
    public PositionBuilder(final MeasurementQuality measurementQuality,
                           final ObservableSatellite satellite) {
