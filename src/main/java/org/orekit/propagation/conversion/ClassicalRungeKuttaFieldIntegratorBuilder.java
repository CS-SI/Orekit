...
public class ClassicalRungeKuttaFieldIntegratorBuilder<T extends CalculusFieldElement<T>> extends
     ...
     */
    public ClassicalRungeKuttaFieldIntegratorBuilder(final double step) {
        super(step);
    }
     ...
     * @see ClassicalRungeKuttaFieldIntegrator
     */
    public ClassicalRungeKuttaFieldIntegratorBuilder(final T step) {
        super(step);
    }

    /** {@inheritDoc} */
    @Override
    public ClassicalRungeKuttaFieldIntegrator<T> buildIntegrator(final Field<T> field, final Orbit orbit, final OrbitType orbitType) {
