...
public class GPSLegacyNavigationMessage extends LegacyNavigationMessage<GPSLegacyNavigationMessage> {
    ...
    public <T extends CalculusFieldElement<T>, F extends FieldGnssOrbitalElements<T, GPSLegacyNavigationMessage, F>>
        ...
        return (F) new FieldGPSLegacyNavigationMessage<>(new FieldKeplerianOrbit<>(field, getOrbit()), this);
    }

    /** {@inheritDoc} */
    @SuppressWarnings("unchecked")
    @Override
    public <P extends FieldGnssOrbitalElements<Gradient, GPSLegacyNavigationMessage, P>>
    ...
    public GPSLegacyNavigationMessageFactory baseFactory(final Frame inertial, final Frame bodyFixed) {
        return new GPSLegacyNavigationMessageFactory(getTimeScales(), getGnssDate().getSystem(), getType(),
                                                     inertial, bodyFixed);
    }
