 ...
 */
public class FieldIRNSSAlmanac<T extends RealFieldElement<T>>
    implements
    FieldIRNSSOrbitalElements<T> {
     ...
     */
    public FieldIRNSSAlmanac(final int prn, final int week, final T toa,
                             final T sqa, final T ecc, final T inc, final T om0,
                             final T dom, final T aop, final T anom,
                             final T af0, final T af1,
    ...
    /**
     * Constructor This constructor converts an IRNSSOrbitalElements (almanac)
     * into a FieldIRNSSAlmanac.
     *
     * @param field
     * @param almanac
     */
    public FieldIRNSSAlmanac(final Field<T> field, final IRNSSOrbitalElements almanac) {
    ...
    public T getMeanMotion() {
        ...
        return FastMath
            .sqrt(absA.getField().getZero().add(IRNSS_MU).divide(absA))
            .divide(absA);
    }
