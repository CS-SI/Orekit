 ...
 */
public class FieldGalileoAlmanac<T extends RealFieldElement<T>>
    implements
    FieldGalileoOrbitalElements<T> {
     ...
     * @param dsqa difference between the square root of the semi-major axis and
     *        the square root of the nominal semi-major axis
     ...
     * @see #GalileoAlmanac(int, int, T, T, T, T, int, T, T, T, T, T, T, int,
     *      int, int, AbsoluteDate)
     */
    @DefaultDataContext
    public FieldGalileoAlmanac(final int prn, final int week, final T toa,
                               ...
                               final T af1, final int healthE5a,
                               final int healthE5b, final int healthE1) {
        this(prn, week, toa, dsqa, ecc, dinc, iod, om0, dom, aop, anom, af0,
             af1, healthE5a, healthE5b, healthE1,
             new FieldGNSSDate<>(week, toa.multiply(1000),
    ...
    /**
     * Constructor This constructor converts a GalileoAlmanac into a
     * FieldGalileoAlmanac.
     *
     * @param field
     * @param almanac a GalileoAlmanac
     */
    public FieldGalileoAlmanac(final Field<T> field, final GalileoAlmanac almanac) {
