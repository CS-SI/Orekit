 ...
 * {@link FieldQZSSOrbitalElements}.
 *
 * @see <a href=
 *      "http://qzss.go.jp/en/technical/download/pdf/ps-is-qzss/is-qzss-pnt-003.pdf?t=1549268771755">
...
public class FieldQZSSPropagator<T extends RealFieldElement<T>> extends FieldAbstractGNSSPropagator<T> {
    ...
    private static final double QZSS_CYCLE_DURATION =
        FieldQZSSOrbitalElements.QZSS_WEEK_IN_SECONDS *
     ...
     * Default constructor.
     * <p>
     * The Field QZSS orbital elements is the only requested parameter to build
     * a FieldQZSSPropagator.
     * </p>
     * <p>
     ...
     * {@code FieldQZSSPropagator(final Field<T> field, final FieldQZSSOrbitalElements<T> qzssOrbit, final Frames frames)}
     * </p>
     *
     * @param field
     * @param qzssOrbit the Field QZSS orbital elements to be used by the
     *        FieldQZSSpropagator.
     ...
     */
    @DefaultDataContext
    public FieldQZSSPropagator(final Field<T> field,
                               final FieldQZSSOrbitalElements<T> qzssOrbit) {
     ...
     * This constructor uses the {@link DataContext#getDefault() default data
     * context}. Another data context can be set using
     * {@code FieldQZSSPropagator(final Field<T> field, final FieldQZSSOrbitalElements<T> qzssOrbit, final AttitudeProvider attitudeProvider, final double mass, final Frame eci, final Frame ecef)}
     * </p>
     *
     * @param field
     * @param qzssOrbit the Field QZSS orbital elements to be used by the
    ...
    public FieldQZSSPropagator(final Field<T> field,
                               final FieldQZSSOrbitalElements<T> qzssOrbit,
                               final Frames frames) {
        this(field, qzssOrbit, Propagator.getDefaultLaw(frames), DEFAULT_MASS,
             frames.getEME2000(),
