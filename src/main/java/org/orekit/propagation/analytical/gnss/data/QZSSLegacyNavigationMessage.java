...
public class QZSSLegacyNavigationMessage extends LegacyNavigationMessage<QZSSLegacyNavigationMessage> {
     ...
     */
    public QZSSLegacyNavigationMessage(final TimeScales timeScales, final SatelliteSystem system, final String type,
    ...
    public <T extends CalculusFieldElement<T>,
            F extends FieldGnssOrbitalElements<T, QZSSLegacyNavigationMessage, F>>
        F toField(final FieldKeplerianOrbit<T> orbit) {
        return (F) new FieldQZSSLegacyNavigationMessage<>(orbit, this);
    }

    /** {@inheritDoc} */
    @Override
    public QZSSLegacyNavigationMessageFactory baseFactory(final Frame inertial, final Frame bodyFixed) {
        return new QZSSLegacyNavigationMessageFactory(getTimeScales(), getSystem(), getType(),
                                                      inertial, bodyFixed);
    }
