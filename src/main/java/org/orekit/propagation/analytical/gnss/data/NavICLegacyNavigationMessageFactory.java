 ...
 * @since 14.0
 */
public class NavICLegacyNavigationMessageFactory
    extends LegacyNavigationMessageFactory<NavICLegacyNavigationMessage> {
    ...
    public NavICLegacyNavigationMessage createFromDrivers() {
        return new NavICLegacyNavigationMessage(getTimeScales(), getType(), getPrn(), getTimeOfEphemeris(),
