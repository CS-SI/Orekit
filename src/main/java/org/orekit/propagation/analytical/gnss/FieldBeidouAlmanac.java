 ...
 */
public class FieldBeidouAlmanac<T extends RealFieldElement<T>>
    implements FieldBeidouOrbitalElements<T> {
     ...
     * @param inc0 the orbit reference inclination 0.0 for GEO satellites and
     *        0.30 * BEIDOU_PI for MEO/IGSO satellites (rad)
     * @param dinc the correction of orbit reference inclination at reference
     *        time (rad)
     ...
     */
    @DefaultDataContext
    public FieldBeidouAlmanac(final int prn, final int week, final T toa,
                              final T sqa, final T ecc, final T inc0,
                              final T dinc, final T om0, final T dom,
                              final T aop, final T anom, final T af0,
                              final T af1, final int health) {
        this(prn, week, toa, sqa, ecc, inc0, dinc, om0, dom, aop, anom, af0,
             af1, health,
             new FieldGNSSDate<T>(week, toa.multiply(1000),
    ...
    /**
     * Constructor This constructor converts a BeidouAlmanac into a
     * FieldBeidouAlmanac.
     *
     * @param field
     * @param almanac a BeidouAlmanac
     */
    public FieldBeidouAlmanac(final Field<T> field, final BeidouAlmanac almanac) {
    ...
    public T getMeanMotion() {
        ...
        return FastMath.sqrt(date.getDate().getField().getZero().add(BEIDOU_MU)
            .divide(absA)).divide(absA);
    }
