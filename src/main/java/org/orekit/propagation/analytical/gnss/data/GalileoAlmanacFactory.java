...
public class GalileoAlmanacFactory extends GNSSOrbitalElementsFactory<GalileoAlmanac> {
    ...
    public GalileoAlmanacFactory(final TimeScales timeScales, final SatelliteSystem system,
        ...
        super(new GalileoAlmanac(timeScales, system),
              inertial, bodyFixed, date, mu);
    }

    /** {@inheritDoc} */
    @Override
    protected GalileoAlmanac createEmptyMessage(final TimeScales timeScales,
                                                final SatelliteSystem system,
                                                final String type) {
        return new GalileoAlmanac(timeScales, system);
    }
