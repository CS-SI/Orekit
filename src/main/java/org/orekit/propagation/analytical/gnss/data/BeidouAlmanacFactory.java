...
public class BeidouAlmanacFactory extends GNSSOrbitalElementsFactory<BeidouAlmanac> {
    ...
    public BeidouAlmanacFactory(final TimeScales timeScales, final SatelliteSystem system,
        ...
        super(new BeidouAlmanac(timeScales, system),
              inertial, bodyFixed, date, mu);
    }

    /** {@inheritDoc} */
    @Override
    protected BeidouAlmanac createEmptyMessage(final TimeScales timeScales,
                                               final SatelliteSystem system,
                                               final String type) {
        return new BeidouAlmanac(timeScales, system);
    }
