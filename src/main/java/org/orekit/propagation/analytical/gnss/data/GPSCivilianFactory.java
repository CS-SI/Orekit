 ...
 * @since 14.0
 */
public class GPSCivilianFactory extends GNSSOrbitalElementsFactory<GPSCivilianNavigationMessage> {
     ...
     */
    public GPSCivilianFactory(final boolean cnv2,
                              final TimeScales timeScales, final SatelliteSystem system,
                              final Frame inertial, final Frame bodyFixed,
                              final AbsoluteDate date, final double mu) {
        super(new GPSCivilianNavigationMessage(cnv2, timeScales, system,
                                               cnv2 ?
    ...
    /** {@inheritDoc} */
    @Override
    protected GPSCivilianNavigationMessage createEmptyMessage(final TimeScales timeScales,
                                                              final SatelliteSystem system,
                                                              final String type) {
        return new GPSCivilianNavigationMessage(cnv2, timeScales, system, type);
    }
