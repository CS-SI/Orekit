...
public interface FieldQZSSOrbitalElements<T extends RealFieldElement<T>> extends FieldGNSSOrbitalElements<T> {
    ...
    // Constants
    /**
     * WGS 84 value of the Earth's universal gravitational parameter for QZSS
     * user in m³/s².
     */
    ...
    /**
     * Gets the estimated group delay differential TGD between SV clock and
     * L1C/A.
     *
     * @return the estimated group delay differential TGD between SV clock and
     *         L1C/A (s)
     */
    T getTGD();
}
