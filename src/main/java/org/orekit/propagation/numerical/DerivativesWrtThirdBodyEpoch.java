 ...
 *  has been added.
 *
 *  Set of {@link org.orekit.propagation.integration.AdditionalEquations additional equations} computing the partial derivatives
 ...
 * @since 11.1
 */
public class DerivativesWrtThirdBodyEpoch implements IntegrableGenerator {
    ...
    public DerivativesWrtThirdBodyEpoch(final String name, final NumericalPropagator propagator) {
        ...
        propagator.addIntegrableGenerator(this);
    }
