    ...
    private boolean findRoot(final OrekitStepInterpolator interpolator,
        ...
        while ((afterRootG == 0.0 || afterRootG > 0.0 == g0Positive) &&
            ...
            try {
                ...
                if (forward) {
                    e.addSuppressed(new OrekitException(e, OrekitMessages.FIND_ROOT, detector, ta, String.format(SCIENTIFIC_FORMAT, ga), tb, String.format(SCIENTIFIC_FORMAT, gb), lastT,
                                                String.format(SCIENTIFIC_FORMAT, lastG)));
                } else {
                    e.addSuppressed(new OrekitException(e, OrekitMessages.FIND_ROOT, detector, tb, String.format(SCIENTIFIC_FORMAT, gb), ta, String.format(SCIENTIFIC_FORMAT, ga), lastT,
                                                String.format(SCIENTIFIC_FORMAT, lastG)));
                }
                throw e;
            }
