    ...
    private boolean findRoot(final OrekitStepInterpolator interpolator,
        ...
        while ((afterRootG == 0.0 || afterRootG > 0.0 == g0Positive) &&
            ...
            try {
                ...
                e.addSuppressed(new OrekitException(e, OrekitMessages.FIND_ROOT, detector, ta, String.format("%.3e", ga), tb, String.format("%.3e", gb), e.getMessage(), loopT, String.format("%.3e", loopG)));
                throw e;
            }
        }
