 ...
 * modify the basic components (orbit, attitude and mass) or add additional data incrementally
 ...
 * propagator all yield and cannot {@link #update(SpacecraftState) update} the data. This happens
 ...
 * state will all yield. This behavior is expected. Another case occurs when users set up additional data
...
public interface AdditionalDataProvider<T> {
     ...
     * <p>
     * Decision to yield is often based on an additional data being {@link SpacecraftState#hasAdditionalData(String)
     ...
     * {@link #getAdditionalData(SpacecraftState) generated} immediately.
     * </p>
