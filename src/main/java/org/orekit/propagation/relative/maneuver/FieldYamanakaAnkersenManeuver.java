 ...
 * @since 14.0
 */
public class FieldYamanakaAnkersenManeuver<T extends CalculusFieldElement<T>>
                extends FieldAbstractRelativeManeuver<T, FieldYamanakaAnkersenProvider<T>> {
     ...
     */
    public FieldYamanakaAnkersenManeuver(final FieldEventDetector<T> trigger,
                                         final FieldVector3D<T> deltaV,
                                         final FieldYamanakaAnkersenProvider<T> chaserAdditionalEquations) {
