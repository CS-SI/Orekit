...
public class FieldTwoImpulseTransfer<T extends CalculusFieldElement<T>> {
     ...
     */
    public FieldTwoImpulseTransfer(final TimeStampedFieldPVCoordinates<T> pvt1, final TimeStampedFieldPVCoordinates<T> pvt2, final FieldVector3D<T> deltaV1, final FieldVector3D<T> deltaV2, final Frame frame) {
        this.pvt1 = pvt1;
        this.pvt2 = pvt2;
     ...
     */
    public FieldTwoImpulseTransfer<T> fromPVTAndVelocities(final TimeStampedFieldPVCoordinates<T> pvt1BeforeMan, final FieldVector3D<T> v1AfterMan, final TimeStampedFieldPVCoordinates<T> pvt2AfterMan, final FieldVector3D<T> v2BeforeMan, final Frame inputFrame) {
        final TimeStampedFieldPVCoordinates<T> pvt1AfterMan = new TimeStampedFieldPVCoordinates<>(pvt1BeforeMan.getDate(), new FieldPVCoordinates<>(pvt1BeforeMan.getPosition(), v1AfterMan));
        final TimeStampedFieldPVCoordinates<T> pvt2BeforeMan = new TimeStampedFieldPVCoordinates<>(pvt2AfterMan.getDate(), new FieldPVCoordinates<>(pvt2AfterMan.getPosition(), v2BeforeMan));
    ...
    public TimeStampedFieldPVCoordinates<T> getPvt1BeforeMan() {
        return new TimeStampedFieldPVCoordinates<>(pvt1.getDate(), new FieldPVCoordinates<>(pvt1.getPosition(), pvt1.getVelocity().subtract(deltaV1)));
    }
    ...
    public TimeStampedFieldPVCoordinates<T> getPvt2AfterMan() {
        return new TimeStampedFieldPVCoordinates<>(pvt2.getDate(), new FieldPVCoordinates<>(pvt2.getPosition(), pvt2.getVelocity().add(deltaV2)));
    }
    ...
    public FieldTwoImpulseTransfer<T> expressInFrame(final Frame outputFrame) {
        return new FieldTwoImpulseTransfer<>(
                getPvt1(outputFrame),
                getPvt2(outputFrame),
