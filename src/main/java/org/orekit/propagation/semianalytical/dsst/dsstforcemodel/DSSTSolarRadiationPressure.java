...
public class DSSTSolarRadiationPressure extends AbstractDSSTGaussianContribution {
     ...
     *            spherical shape model (for shadow computation)
     */
    public DSSTSolarRadiationPressure(final double cr,
                                      final double area,
     ...
     *            spherical shape model (for shadow computation)
     */
    public DSSTSolarRadiationPressure(final double dRef,
                                      final double pRef,
                                      final double cr,
                                      final double area,
                                      final PVCoordinatesProvider sun,
     ...
     */
    private int realQuarticRoots(final double[] a,
                                 final double[] y) {
     ...
     * @return the number of real roots
     */
    private int realCubicRoots(final double[] a,
                               final double[] y) {
     ...
     * @return the number of real roots
     */
    private int realQuadraticRoots(final double[] a,
                                   final double[] y) {
        final double aa = a[0];
        final double bb = -a[1];
        final double cc = a[2];
