...
public class DSSTSolarRadiationPressure extends AbstractDSSTGaussianContribution {
    ...
    */
     ...
     */
    public double[] getMeanElementRate2(final SpacecraftState state) throws OrekitException {
        ...
        final double I = getRetrogradeFactor();
        ...
        meanElementRate[3] =  getRetrogradeFactor() * cvgo2ab * k;
        // dp/dt = C*V*h*γ/2*A*B
     ...
     * @return V coefficient for mean element rates direct computation
     * @exception OrekitException if sun position cannot be computed
     */
    private double computeV(final SpacecraftState state) throws OrekitException {
