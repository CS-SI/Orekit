...
public enum OrekitMessages implements Localizable {
    ...
    CCSDS_UNKNOWN_GM("the central body gravitational coefficient cannot be retrieved from the OPM"),
    ...
    CCSDS_INVALID_ODM_BLOCK("not a valid ODMBlock for this ODM File"),
    CCSDS_INVALID_FRAME("frame {0} is not valid in this ODM file context"),
    CCSDS_OEM_TIMESYSTEM_NOT_IDENTICAL("the time scales of the ephemeris blocks are not identical"),
