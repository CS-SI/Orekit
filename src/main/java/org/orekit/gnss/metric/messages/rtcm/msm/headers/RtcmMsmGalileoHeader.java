...
public class RtcmMsmGalileoHeader extends RtcmMsmHeader {
    ...
    static {
        ...
        SIGNAL_ID_MAP.put( 2, RtcmMsmSignalId.GAL_1C);
        SIGNAL_ID_MAP.put( 3, RtcmMsmSignalId.GAL_1A);
        SIGNAL_ID_MAP.put( 4, RtcmMsmSignalId.GAL_1B);
        SIGNAL_ID_MAP.put( 5, RtcmMsmSignalId.GAL_1X);
        SIGNAL_ID_MAP.put( 6, RtcmMsmSignalId.GAL_1Z);
        SIGNAL_ID_MAP.put( 8, RtcmMsmSignalId.GAL_6C);
        SIGNAL_ID_MAP.put( 9, RtcmMsmSignalId.GAL_6A);
        SIGNAL_ID_MAP.put(10, RtcmMsmSignalId.GAL_6B);
        SIGNAL_ID_MAP.put(11, RtcmMsmSignalId.GAL_6X);
        SIGNAL_ID_MAP.put(12, RtcmMsmSignalId.GAL_6Z);
        SIGNAL_ID_MAP.put(14, RtcmMsmSignalId.GAL_7I);
        SIGNAL_ID_MAP.put(15, RtcmMsmSignalId.GAL_7Q);
        SIGNAL_ID_MAP.put(16, RtcmMsmSignalId.GAL_7X);
        SIGNAL_ID_MAP.put(18, RtcmMsmSignalId.GAL_8I);
        SIGNAL_ID_MAP.put(19, RtcmMsmSignalId.GAL_8Q);
        SIGNAL_ID_MAP.put(20, RtcmMsmSignalId.GAL_8X);
        SIGNAL_ID_MAP.put(22, RtcmMsmSignalId.GAL_5I);
    ...
    public List<SatInSystem> convertSatellitesMask() {
        ...
        for (int satId = 1; satId <= 64; satId++) {
            if ((this.getSatellitesMask() >> (64 - satId) & 1) == 1) {
                ...
                satellites.add(new SatInSystem(SatelliteSystem.GALILEO, satId < 53 ? satId : -1));
            }
        }
        return satellites;
    }
