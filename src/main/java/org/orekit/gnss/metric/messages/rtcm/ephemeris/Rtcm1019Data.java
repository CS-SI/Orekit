...
public class Rtcm1019Data extends RtcmEphemerisData {
    ...
    /** Factory for GPS navigation message. */
    private final GPSLegacyNavigationMessageFactory factory;

    /** Constructor.
     * @param satelliteId satellite ID
     * @param accuracyProvider accuracy provider
     * @param factory factory for GPS navigation message
     * @since 14.0
     */
    public Rtcm1019Data(final int satelliteId, final AccuracyProvider accuracyProvider,
