...
/**
 * RTCM 1127 message: BEIDOU MSM7.
 * @author Nathan Schiffmacher
 * @since 14.0
 */
public class Rtcm1127 extends RtcmMsmMessage<RtcmMsmBeidouHeader> {
    /**
     * Constructor.
     ...
     */
    public Rtcm1127(final int typeCode, final RtcmMsmBeidouHeader header, final List<RtcmMsmCellData> cells) {
