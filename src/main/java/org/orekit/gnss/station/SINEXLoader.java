 ...
 */
package org.orekit.gnss.station;
...
public class SINEXLoader {
        ...
        public void loadData(final InputStream input, final String name)
            ...
            try (BufferedReader reader = new BufferedReader(new InputStreamReader(input, StandardCharsets.UTF_8))) {
                ...
                for (line = reader.readLine(); line != null; line = reader.readLine()) {
                    ++lineNumber;
                    // TODO For now, only few keys are supported: SITE/ID, SITE/ECCENTRICITY, SOLUTION/EPOCHS and SOLUTION/ESTIMATE
    ...
    private AbsoluteDate stringEpochToAbosluteDate(final String stringDate) {
        ...
        // Read fields
        final int twoDigitsYear = Integer.valueOf(fields[0]);
        final int day = Integer.valueOf(fields[1]);
        final int secInDay = Integer.valueOf(fields[2]);
