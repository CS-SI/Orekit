...
public class Vector3DDS implements Serializable {
    ...
    public DerivativeStructure dotProduct(final Vector3D v) {
        return linearCombination(v.getX(), x, v.getY(), y, v.getZ(), z);
    }
    ...
    public Vector3DDS crossProduct(final Vector3DDS v) {
        return new Vector3DDS(linearCombination(y, v.z, z.negate(), v.y),
                              linearCombination(z, v.x, x.negate(), v.z),
                              linearCombination(x, v.y, y.negate(), v.x));
    }
    ...
    public Vector3DDS crossProduct(final Vector3D v) {
        return new Vector3DDS(linearCombination(v.getZ(), y, v.getY(), z.negate()),
                              linearCombination(v.getX(), z, v.getZ(), x.negate()),
                              linearCombination(v.getY(), x, v.getX(), y.negate()));
    }
     ...
     */
    private static DerivativeStructure linearCombination(final DerivativeStructure a1, final DerivativeStructure b1,
     ...
     */
    private static DerivativeStructure linearCombination(final double a1, final DerivativeStructure b1,
     ...
     * @see #linearCombination(DerivativeStructure, DerivativeStructure, DerivativeStructure, DerivativeStructure, DerivativeStructure, DerivativeStructure, DerivativeStructure, DerivativeStructure)
     */
    static DerivativeStructure linearCombination(final DerivativeStructure a1, final DerivativeStructure b1,
                                                 final DerivativeStructure a2, final DerivativeStructure b2,
