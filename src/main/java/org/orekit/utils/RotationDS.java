 ...
 *
 * <p>
 * WARNING: this class has been borrowed from a development version of Apache Commons Math.
 * It is NOT intended to remain in Orekit and will be removed as soon as an officially
 * published version of Apache Commons Math providing it will be available.
 * </p>
 * @see Vector3DDSDS
 * @see RotationOrder
 */
...
public class RotationDS implements Serializable {
    ...
    public RotationDS(Vector3DDS u1, Vector3DDS u2, Vector3DDS v1, Vector3DDS v2)
        ...
        final DerivativeStructure[][] m = new DerivativeStructure[][] {
            {
                Vector3DDS.linearCombination(u1.getX(), v1.getX(), u2.getX(), v2.getX(), u3.getX(), v3.getX()),
                Vector3DDS.linearCombination(u1.getY(), v1.getX(), u2.getY(), v2.getX(), u3.getY(), v3.getX()),
                Vector3DDS.linearCombination(u1.getZ(), v1.getX(), u2.getZ(), v2.getX(), u3.getZ(), v3.getX())
            },
            {
                Vector3DDS.linearCombination(u1.getX(), v1.getY(), u2.getX(), v2.getY(), u3.getX(), v3.getY()),
                Vector3DDS.linearCombination(u1.getY(), v1.getY(), u2.getY(), v2.getY(), u3.getY(), v3.getY()),
                Vector3DDS.linearCombination(u1.getZ(), v1.getY(), u2.getZ(), v2.getY(), u3.getZ(), v3.getY())
            },
            {
                Vector3DDS.linearCombination(u1.getX(), v1.getZ(), u2.getX(), v2.getZ(), u3.getX(), v3.getZ()),
                Vector3DDS.linearCombination(u1.getY(), v1.getZ(), u2.getY(), v2.getZ(), u3.getY(), v3.getZ()),
                Vector3DDS.linearCombination(u1.getZ(), v1.getZ(), u2.getZ(), v2.getZ(), u3.getZ(), v3.getZ())
            }
        };
