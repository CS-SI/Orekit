 ...
 *  any eccentric orbits.<br>
 *  The methods of these classes were not added in {@link org.orekit.control.relative.RPO RPO} interface since it
 *  applies only to elliptical target orbits.
 *  </li>
 *  <li>{@link org.orekit.control.relative.TeardropCircularWaypointCalculator TeardropCircularWaypointCalculator}
 *  Computes the waypoints to realize a teardrop maneuver when the target is in a circular orbit.<br>
 *  The methods of these classes were not added in {@link org.orekit.control.relative.RPO RPO} interface since it
