...
public class TriggerDate implements ManeuverTriggersResetter, AdditionalDataProvider<double[]> {
    ...
    public TriggerDate(final String stmName, final String triggerName, final boolean manageStart,
        ...
        this.massDepletionDelay = new MassDepletionDelay(triggerName, manageStart, maneuver, isMassInStm);
        this.manageStart        = manageStart;
        this.maneuver           = maneuver;
        this.threshold          = threshold;
        this.stateDimension     = massDepletionDelay.getDimension();
    ...
    public SpacecraftState resetState(final SpacecraftState state) {
        ...
        if (stateDimension == 7) {
            final double massDerivative = maneuver.getPropulsionModel().getMassDerivatives(state,
                    maneuver.getParameters(state.getDate()));
