...
/** Keys for {@link ODMCovariance ODM covariance} entries.
 * @author Luc Maisonobe
 * @since 11.0
 */
public enum ODMCovarianceKey {
     ...
     */
    ODMCovarianceKey(final TokenProcessor processor) {
     ...
     */
    public boolean process(final ParseToken token, final ParsingContext context, final ODMCovariance data) {
    ...
    interface TokenProcessor {
         ...
         * @return true of token was accepted
         */
        boolean process(ParseToken token, ParsingContext context, ODMCovariance data);
    }
