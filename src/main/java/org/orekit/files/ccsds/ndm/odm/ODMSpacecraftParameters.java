 ...
 * @since 6.1
 */
public class ODMSpacecraftParameters extends CommentsContainer implements Data {
     ...
     */
    public ODMSpacecraftParameters() {
        mass          = Double.NaN;
    ...
    public void checkMandatoryEntries() {
        checkNotNaN(mass, ODMSpacecraftParametersKey.MASS);
    }
