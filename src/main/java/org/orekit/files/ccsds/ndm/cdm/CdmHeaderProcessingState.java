...
/** {@link ProcessingState} for {@link CdmHeader CDM header}.
 * @author Melina Vanel
 * @since 11.2
 */
public class CdmHeaderProcessingState implements ProcessingState {
     ...
     */
    public CdmHeaderProcessingState(final CdmParser parser) {
    ...
    public boolean processToken(final ParseToken token) {
        ...
        try {
            ...
            try {
                return CdmHeaderKey.valueOf(token.getName()).process(token, context, parser.getHeader());
