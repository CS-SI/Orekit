 ...
 * @since 6.1
 */
public class OMMFile extends ODMFile<Segment<OMMMetadata, OMMData>> implements TimeStamped {
    ...
    public TLE generateTLE() {
        ...
        final ODMKeplerianElements kep = getData().getKeplerianElementsBlock();
