 ...
 * @since 6.1
 */
public class OEMParser extends OCommonParser<OEMFile, OEMParser> implements EphemerisFileParser<OEMFile> {
     ...
     * OEMFile   oem    = new KVNLexicalAnalyzer(source).accept(parser);
     * }
     * </pre>
     * </p>
     */
