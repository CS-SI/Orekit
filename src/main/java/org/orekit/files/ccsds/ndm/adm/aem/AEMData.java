...
public class AEMData implements NDMData {
    ...
    public class AttitudeEphemeridesBlock implements AttitudeEphemerisSegment {
        ...
        public AttitudeEphemeridesBlock() {
            ...
            metaData          = new APMMetadata(AEMData.this);
        }
         ...
         */
        public APMMetadata getMetaData() {
            return metaData;
        }
        ...
        public TimeScale getTimeScale() {
            return metaData.getTimeSystem().
                            getTimeScale(getConventions(), getDataContext().getTimeScales());
        }
