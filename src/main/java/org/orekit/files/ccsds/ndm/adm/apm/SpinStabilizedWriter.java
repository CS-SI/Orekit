...
class SpinStabilizedWriter extends AbstractWriter {
    ...
    protected void writeContent(final Generator generator) throws IOException {
        ...
        if (spinStabilized.hasMomentum()) {
            // momentum
            generator.writeOptionalDoubleEntry(SpinStabilizedKey.MOMENTUM_ALPHA.name(), spinStabilized.getMomentumAlpha(), Unit.DEGREE,     true);
            generator.writeOptionalDoubleEntry(SpinStabilizedKey.MOMENTUM_DELTA.name(), spinStabilized.getMomentumDelta(), Unit.DEGREE,     true);
            generator.writeOptionalDoubleEntry(SpinStabilizedKey.NUTATION_VEL.name(),   spinStabilized.getNutationVel(),   Units.DEG_PER_S, true);
        } else if (spinStabilized.hasNutation()) {
            // nutation
            generator.writeOptionalDoubleEntry(SpinStabilizedKey.NUTATION.name(),       spinStabilized.getNutation(),       Unit.DEGREE, true);
            generator.writeOptionalDoubleEntry(SpinStabilizedKey.NUTATION_PER.name(),   spinStabilized.getNutationPeriod(), Unit.SECOND, true);
            generator.writeOptionalDoubleEntry(SpinStabilizedKey.NUTATION_PHASE.name(), spinStabilized.getNutationPhase(),  Unit.DEGREE, true);
        }
