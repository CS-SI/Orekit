...
public class OCMFile extends OGMFile {
    ...
    public static class OCMMetaData extends ODMMetaData {
        ...
        private String defEpochT0;

        /** Time system in which {@link #defEpochT0} is defined. */
        private CcsdsTimeScale defTimeSystem;
        ...
        /** Difference (TAI – UTC) in seconds at epoch {@link #defEpochT0}. */
        private double taimutcT0;

        /** Difference (UT1 – UTC) in seconds at epoch {@link #defEpochT0}. */
        ...
        /** Set the default epoch to which <em>all</em> relative times are referenced in data blocks.
         * @param defEpochT0 default epoch to which <em>all</em> relative times are referenced in data blocks
         */
        void setDefEpochT0(final String defEpochT0) {
            this.defEpochT0 = defEpochT0;
        }

        /** Get the time system in which {@link #getDefEpochT0()} is defined.
         * @return time system in which {@link #getDefEpochT0()} is defined
         */
        public CcsdsTimeScale getDefTimeSystem() {
            return defTimeSystem;
        }

        /** Set the time system in which {@link #getDefEpochT0()} is defined.
         * @param defTimeSystem time system in which {@link #getDefEpochT0()} is defined
         */
        void setDefTimeSystem(final CcsdsTimeScale defTimeSystem) {
            this.defTimeSystem = defTimeSystem;
        }
        ...
        /** Get the difference (TAI – UTC) in seconds at epoch {@link #getDefEpochT0()}.
         * @return difference (TAI – UTC) in seconds at epoch {@link #getDefEpochT0()}
         */
        public double getTaimutcT0() {
            return taimutcT0;
        }

        /** Set the difference (TAI – UTC) in seconds at epoch {@link #getDefEpochT0()}.
         * @param taimutcT0 difference (TAI – UTC) in seconds at epoch {@link #getDefEpochT0()}
         */
        void setTaimutcT0(final double taimutcT0) {
            this.taimutcT0 = taimutcT0;
        }

        /** Get the difference (UT1 – UTC) in seconds at epoch {@link #getDefEpochT0()}.
         * @return difference (UT1 – UTC) in seconds at epoch {@link #getDefEpochT0()}
         */
        public double getUt1mutcT0() {
            return ut1mutcT0;
        }

        /** Set the difference (UT1 – UTC) in seconds at epoch {@link #getDefEpochT0()}.
         * @param ut1mutcT0 difference (UT1 – UTC) in seconds at epoch {@link #getDefEpochT0()}
         */
        ...
        private AbsoluteDate absoluteToEpoch(final String value) {
            return defTimeSystem.parseDate(value,
        ...
        private AbsoluteDate absoluteOrRelativeToEpoch(final String value) {
            if (value.contains("T")) {
                ...
                // relative date
                return getDefEpochT0().shiftedBy(Double.parseDouble(value));
            }
        }
