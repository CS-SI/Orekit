...
class FieldGridCell<T extends CalculusFieldElement<T>> {
     ...
     */
    public FieldGridCell(final T deltaSouth, final T deltaWest, final double sizeLat, final double sizeLon,
     ...
     */
    public FieldGridCell(final BiFunction<T> function,
     ...
     */
    public FieldGridCell(final TriFunction<T> function,
     ...
     */
    public FieldGridCell(final QuarticFunction<T> function,
                         final FieldGridCell<T> cell1, final FieldGridCell<T> cell2,
     ...
     */
    public FieldGridCell(final QuinticFunction<T> function,
                         final FieldGridCell<T> cell1, final FieldGridCell<T> cell2, final FieldGridCell<T> cell3,
