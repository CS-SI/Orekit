...
/**
 * Factory for common equations used in both {@link JB2008} and {@link JB2006} models.
 ...
 * @since 13.1
 */
public final class JacchiaBowmanEquationsFactory {

    /** Minimum altitude (m) for JB models use. */
    public static final double ALT_MIN = 90000.;

    /** The alpha are the thermal diffusion coefficients in equation (6). */
    public static final double[] ALPHA = {0, 0, 0, 0, -0.38};

    /** Natural logarithm of 10.0. */
    public static final double LOG10  = FastMath.log(10.);

    /** Molecular weights in order: N2, O2, O, Ar, He and H. */
    public static final double[] AMW = {28.0134, 31.9988, 15.9994, 39.9480, 4.0026, 1.00797};

    /** Avogadro's number in mks units (molecules/kmol). */
    public static final double AVOGAD = 6.02257e26;

    /** The FRAC are the assumed sea-level volume fractions in order: N2, O2, Ar, and He. */
    public static final double[] FRAC = {0.78110, 0.20955, 9.3400e-3, 1.2890e-5};

    /** Universal gas-constant in mks units (joules/K/kmol). */
    public static final double RSTAR  = 8.31432;

    /** Value used to establish height step sizes in the regime 90km to 105km. */
    public static final double R1 = 0.010;

    /** Value used to establish height step sizes in the regime 105km to 500km. */
    public static final double R2 = 0.025;

    /** Value used to establish height step sizes in the regime above 500km. */
    public static final double R3 = 0.075;

    /** Weights for the Newton-Cotes five-points quadrature formula. */
    public static final double[] WT = {0.311111111111111, 1.422222222222222, 0.533333333333333, 1.422222222222222, 0.311111111111111};

    /** DTC relative data. */
    public static final double[] BDT_SUB = {-0.457512297e+01, -0.512114909e+01, -0.693003609e+02,
    ...
    /** DTC relative data.  */
    public static final double[] CDT_SUB = {-0.155986211e+02, -0.512114909e+01, -0.693003609e+02,
                                            0.203716701e+03, 0.703316291e+03, -0.194349234e+04,
    ...
    /** Default constructor. */
    private JacchiaBowmanEquationsFactory() {
        // empty for final class
    }
     ...
     */
    public static double solarTimeHour(final double h) {
     ...
     * @return the solar time in hours
     */
    public static <T extends CalculusFieldElement<T>> T solarTimeHour(final T h) {
     ...
     */
    public static double tSubL(final double eta, final double theta,
     ...
     * @return Tl temperature computed by Equation (17)
     */
    public static <T extends CalculusFieldElement<T>>  T tSubL(final T eta, final T theta,
     ...
     */
    public static double tSubX(final double tInf) {
     ...
     * @return Tx temperature at inflection point, computed by Equation (9)
     */
    public static <T extends CalculusFieldElement<T>>  T tSubX(final T tInf) {
     ...
     */
    public static double gSubX(final double tSubX) {
     ...
     * @return the temperature gradient at the inflection point computed by Equation (11)
     */
    public static <T extends CalculusFieldElement<T>> T gSubX(final T tSubX) {
     ...
     * @return the Tc array
     */
    public static double[] tSubCArray(final double tSubX, final double gSubX,
                                      final double tInf) {
     ...
     * @return the Tc array
     */
    public static <T extends CalculusFieldElement<T>> T[] tSubCArray(final T tSubX, final T gSubX,
     ...
     */
    public static double localTemp(final double z, final double[] tc) {
     ...
     * @param <T> type of the field elements
     */
    public static <T extends CalculusFieldElement<T>> T localTemp(final T z, final T[] tc) {
     ...
     */
    public static double mBar(final double z) {
     ...
     * @param <T> type of the field elements
     */
    public static <T extends CalculusFieldElement<T>>  T mBar(final T z) {
     ...
     */
    public static double gravity(final double z) {
     ...
     * @param <T> type of the field elements
     */
    public static <T extends CalculusFieldElement<T>> T gravity(final T z) {
     ...
     */
    public static double dayOfYear(final double dateMJD) {
     ...
     * @return the number days in year
     */
    public static <T extends CalculusFieldElement<T>> T dayOfYear(final T dateMJD) {
     ...
     */
    public static double dlrsl(final double altKm, final double dateMJD, final double satLat) {
     ...
     * @return the J70 Seasonal-Latitudinal Variation
     */
    public static <T extends CalculusFieldElement<T>> T dlrsl(final T altKm, final T dateMJD, final T satLat) {
     ...
     */
    public static double densityCorrectionFactor(final double altKm, final double f10B) {
     ...
     * @return the high altitude exospheric density correction factor
     */
    public static <T extends CalculusFieldElement<T>> T densityCorrectionFactor(final T altKm, final double f10B,
                                                                                final Field<T> field) {
     ...
     */
    public static double dTc(final double f10, final double solarTime,
     ...
     * @return dTc correction
     */
    public static <T extends CalculusFieldElement<T>> T dTc(final double f10, final T solarTime,
