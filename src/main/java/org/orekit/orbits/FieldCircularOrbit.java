...
public class FieldCircularOrbit<T extends CalculusFieldElement<T>> extends FieldOrbit<T> implements PositionAngleBased {
    ...
    public boolean hasNonKeplerianAcceleration() {
        return aDot.getReal() != 0. && exDot.getReal() != 0 && iDot.getReal() != 0. && eyDot.getReal() != 0. &&
                raanDot.getReal() != 0. && cachedAlphaDot.getReal() != computeKeplerianAlphaDot(cachedPositionAngleType, a, ex, ey, getMu(), cachedAlpha, cachedPositionAngleType).getReal();
    }
