...
public class FieldEquinoctialOrbit<T extends CalculusFieldElement<T>> extends FieldOrbit<T>
    ...
    public boolean hasNonKeplerianAcceleration() {
        return aDot.getReal() != 0. && exDot.getReal() != 0 && hxDot.getReal() != 0. && eyDot.getReal() != 0. &&
                hyDot.getReal() != 0. && cachedLDot.getReal() != computeKeplerianLDot(cachedPositionAngleType, a, ex, ey, getMu(), cachedL, cachedPositionAngleType).getReal();
    }
