...
public class SEMParserTest {
    ...
    public void testLoadData() throws IOException, ParseException, OrekitException {
        ...
        Assert.assertEquals(6.84547424316406E-03,  (alm.getI0() / GNSSOrbitalElements.GNSS_PI) - 0.30, 1.E-17);
        Assert.assertEquals(0., alm.getIDot(), 0.);
        Assert.assertEquals(-2.08778738975525E-01, alm.getOmega0() / GNSSOrbitalElements.GNSS_PI, FastMath.ulp(-2E-01));
        Assert.assertEquals(-2.48837750405073E-09, alm.getOmegaDot() / GNSSOrbitalElements.GNSS_PI, FastMath.ulp(-3E-09));
        Assert.assertEquals(1.46086812019348E-01, alm.getPa() / GNSSOrbitalElements.GNSS_PI, FastMath.ulp(1E-01));
        Assert.assertEquals(4.55284833908081E-01, alm.getM0() / GNSSOrbitalElements.GNSS_PI, FastMath.ulp(4E-01));
    ...
    public void testLoadDefault() throws IOException, ParseException, OrekitException {
        ...
        Assert.assertEquals(5.53321838378906E-03,  (alm.getI0() / GNSSOrbitalElements.GNSS_PI) - 0.30, 1.E-17);
        Assert.assertEquals(0., alm.getIDot(), 0.);
        Assert.assertEquals(4.53996539115906E-01, alm.getOmega0() / GNSSOrbitalElements.GNSS_PI, FastMath.ulp(5E-01));
        Assert.assertEquals(-2.46291165240109E-09, alm.getOmegaDot() / GNSSOrbitalElements.GNSS_PI, FastMath.ulp(-3E-09));
        Assert.assertEquals(7.92368650436401E-02, alm.getPa() / GNSSOrbitalElements.GNSS_PI, FastMath.ulp(8E-02));
        Assert.assertEquals(3.84885787963867E-01, alm.getM0() / GNSSOrbitalElements.GNSS_PI, FastMath.ulp(4E-01));
