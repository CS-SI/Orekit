...
public class Rtcm1044Test {
    ...
    public void testParseMessage() {
        ...
        final GNSSPropagator<QZSSLegacyNavigationMessage> propagator =
            new GNSSPropagator<>(qzssMessage.factory(context.getFrames().getEME2000(),
        ...
        Assertions.assertEquals(1.4586338170358127E-4, qzssMessage.getOrbit().getKeplerianMeanMotion(), eps);
        Assertions.assertEquals(1.4587496546628753E-4, qzssMessage.getOrbit().getKeplerianMeanMotion() + qzssMessage.getDeltaN0(), eps);
        Assertions.assertEquals(0.1671775426328288, qzssMessage.getOrbit().getMeanAnomaly(), eps);
