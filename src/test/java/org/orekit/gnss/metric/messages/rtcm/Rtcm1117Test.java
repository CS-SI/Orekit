...
class Rtcm1117Test {
    ...
    void testPerfectValue() {
        ...
        final Rtcm1117 rtcm1117 = (Rtcm1117) new RtcmMessagesParser(messages,
        ...
        Assertions.assertEquals(new SatInSystem("J02"), cells.getFirst().getSatelliteData().getSatellite());
        final double eps = 1.0e-13;
        Assertions.assertEquals(0.123, cells.getFirst().getSatelliteData().getIntMillisRoughRange(), eps);
        Assertions.assertEquals(0, cells.getFirst().getSatelliteData().getExtendedSatelliteData());
        Assertions.assertEquals(8.583984375e-4, cells.getFirst().getSatelliteData().getModMillisRoughRange(), eps);
        Assertions.assertEquals(79, cells.getFirst().getSatelliteData().getRoughPhaserangeRate());

        // Verify first cell sig data
        Assertions.assertEquals(RtcmMsmSignalId.QZSS_1C, cells.getFirst().getSignalData().getSignalId());
        Assertions.assertEquals(0.2142, cells.getFirst().getSignalData().getFinePhaserangeRate(), eps);
        Assertions.assertEquals(9.98079776763916e-8, cells.getFirst().getSignalData().getFinePseudorange(), eps);
        Assertions.assertEquals(2.829674631357193e-7, cells.getFirst().getSignalData().getFinePhaserange(), eps);
        Assertions.assertEquals(704, cells.getFirst().getSignalData().getLockTimeIndicator());
        Assertions.assertEquals(36.8125, cells.getFirst().getSignalData().getCnr(), eps);
