...
public class Rtcm1240Test {
    ...
    public void testPerfectValue() {
        ...
        // Verify size
        Assert.assertEquals(1,                            rtcm1240.getData().size());

        // Verify header
        Assert.assertEquals(1240,                         rtcm1240.getTypeCode());
        Assert.assertEquals(64711.0,                      rtcm1240.getHeader().getEpochTime1s(), eps);
        Assert.assertEquals(30.0,                         rtcm1240.getHeader().getSsrUpdateInterval().getUpdateInterval(), eps);
        Assert.assertEquals(0,                            rtcm1240.getHeader().getMultipleMessageIndicator());
        Assert.assertEquals(7,                            rtcm1240.getHeader().getIodSsr());
        Assert.assertEquals(3951,                         rtcm1240.getHeader().getSsrProviderId());
        Assert.assertEquals(1,                            rtcm1240.getHeader().getSsrSolutionId());
        Assert.assertEquals(1,                            rtcm1240.getHeader().getNumberOfSatellites());
