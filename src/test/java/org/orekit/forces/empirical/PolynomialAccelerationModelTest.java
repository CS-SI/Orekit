...
public class PolynomialAccelerationModelTest extends AbstractForceModelTest {
    ...
    public void testParameterDerivative() {
        ...
        ppa.getParametersDrivers().get(0).setValue(0.00001, null);
        ppa.getParametersDrivers().get(1).setValue(0.00002, null);
        ppa.getParametersDrivers().get(2).setValue(0.00003, null);
        ppa.getParametersDrivers().get(3).setValue(0.00004, null);
