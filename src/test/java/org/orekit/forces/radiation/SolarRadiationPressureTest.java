...
public class SolarRadiationPressureTest extends AbstractLegacyForceModelTest {
    ...
    public void testParameterDerivativeBox() {
        ...
        checkParameterDerivative(state, forceModel, RadiationSensitive.ABSORPTION_COEFFICIENT_INITIAL_SPAN, 0.25, 1.9e-15);
        checkParameterDerivative(state, forceModel, RadiationSensitive.REFLECTION_COEFFICIENT_INITIAL_SPAN, 0.25, 6.9e-15);
