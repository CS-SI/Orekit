...
class SHMFormatReaderTest {
    ...
    void testRegular03cNormalized() {
        ...
        assertEquals(0.957201462136e-06 + offsetYear * 0.490000000000e-11,
                            harmonics.getNormalizedCnm(3, 0), 1.0e-15);
        assertEquals( 0.174786174485e-06, harmonics.getNormalizedCnm(5, 5), 1.0e-15);
        assertEquals( 0.0,                harmonics.getNormalizedSnm(4, 0), 1.0e-15);
        assertEquals( 0.308834784975e-06, harmonics.getNormalizedSnm(4, 4), 1.0e-15);
        assertEquals(0.3986004415E+15 , provider.getMu(),  0);
        assertEquals(0.6378136460E+07 , provider.getAe(),  0);
