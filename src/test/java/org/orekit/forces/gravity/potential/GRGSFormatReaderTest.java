...
class GRGSFormatReaderTest {
    ...
    void testRegular05cNormalized() {
        ...
        assertEquals(0.95857491635129E-06 + offsetYear * 0.28175700027753E-11,
                            harmonics.getNormalizedCnm(3, 0), 1.0e-15);
        assertEquals( 0.17481512311600E-06, harmonics.getNormalizedCnm(5, 5), 1.0e-15);
        assertEquals( 0.0,                harmonics.getNormalizedSnm(4, 0), 1.0e-15);
        assertEquals( 0.30882755318300E-06, harmonics.getNormalizedSnm(4, 4), 1.0e-15);
        assertEquals(0.3986004415E+15 , provider.getMu(),  0);
        assertEquals(0.6378136460E+07 , provider.getAe(),  0);
    }
