...
class Alfriend1999MaxTest {
     ...
     */
    private final ShortTermEncounter2DPOCMethod method = new Alfriend1999Max();
    ...
    void testComputeExpectedMaximumProbabilityOfCollisionFromArmellinAppendix() {
    ...
    void testCompareStatisticsAboutMaximumProbabilityOfCollisionWithArmellinData() throws IOException {
        // GIVEN
        ...
        // THEN
        Assertions.assertTrue(statistics.getMean() <= 2.465783599125748E-10);
        Assertions.assertTrue(statistics.getStandardDeviation() <= 6.701558905623221E-10);
    }
    ...
    @Test
    @DisplayName("Test this method on Armellin appendix test case")
    void testComputeExpectedMaximumProbabilityOfCollisionFromArmellinAppendixField() {
        ...
        final FieldMatrix<Binary64> primaryCovarianceMatrixInPrimaryRTN = new BlockFieldMatrix<>(
                new Binary64[][] { { new Binary64(9.31700905887535e1), new Binary64(-2.623398113500550e2), new Binary64(
                        2.360382173935300e1), new Binary64(0), new Binary64(0), new Binary64(0) },
                                   { new Binary64(-2.623398113500550e2), new Binary64(1.77796454279511e4), new Binary64(
                                           -9.331225387386501e1), new Binary64(0), new Binary64(0), new Binary64(0) },
                                   { new Binary64(2.360382173935300e1), new Binary64(-9.331225387386501e1), new Binary64(
                                           1.917372231880040e1), new Binary64(0), new Binary64(0), new Binary64(0) },
                                   { new Binary64(0), new Binary64(0), new Binary64(0), new Binary64(0), new Binary64(
                                           0), new Binary64(0) }, { new Binary64(0), new Binary64(0), new Binary64(
                        0), new Binary64(0), new Binary64(0), new Binary64(0) }, { new Binary64(0), new Binary64(
                        0), new Binary64(0), new Binary64(0), new Binary64(0), new Binary64(0) } });
        ...
        final FieldMatrix<Binary64> secondaryCovarianceMatrixInSecondaryRTN = new BlockFieldMatrix<>(
                new Binary64[][] { { new Binary64(6.346570910720371e2), new Binary64(-1.962292216245289e3), new Binary64(
                        7.077413655227660e1), new Binary64(0), new Binary64(0), new Binary64(0) },
                                   { new Binary64(-1.962292216245289e3), new Binary64(8.199899363150306e5), new Binary64(
                                           1.139823810584350e3), new Binary64(0), new Binary64(0), new Binary64(0) },
                                   { new Binary64(7.077413655227660e1), new Binary64(1.139823810584350e3), new Binary64(
                                           2.510340829074070e2), new Binary64(0), new Binary64(0), new Binary64(0) },
                                   { new Binary64(0), new Binary64(0), new Binary64(0), new Binary64(0), new Binary64(
                                           0), new Binary64(0) }, { new Binary64(0), new Binary64(0), new Binary64(
                        0), new Binary64(0), new Binary64(0), new Binary64(0) }, { new Binary64(0), new Binary64(
                        0), new Binary64(0), new Binary64(0), new Binary64(0), new Binary64(0) } });
    ...
    @Test
    @DisplayName("Test this method on Armellin's data and compare statistics")
    void testCompareStatisticsAboutMaximumProbabilityOfCollisionWithArmellinDataField() throws IOException {
        // GIVEN
        final List<ArmellinDataRow> armellinDataRowList = ArmellinDataLoader.load();

        // WHEN
        final DescriptiveStatistics statistics =
                ArmellinStatistics.getMaxFieldProbabilityOfCollisionRelativeDifferenceStatistics(
                        armellinDataRowList);
    ...
    void testReturnExpectedValueWithDerivative() {
        // GIVEN
        final DSFactory factory = new DSFactory(5, 6);
        ...
        final double taylorResult = resultNominal.getValue().taylor(dxm, dym, dSigmaX, dSigmaY, dRadius);
