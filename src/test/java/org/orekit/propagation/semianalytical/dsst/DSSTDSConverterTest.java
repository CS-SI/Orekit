...
public class DSSTDSConverterTest {
    ...
    public void testConversion() {
        ...
        // Force model
        final DSSTForceModel force = new DSSTNewtonianAttraction(Constants.WGS84_EARTH_MU);
        force.getParametersDrivers()[0].setSelected(true);

        // Convert state
        DSSTDSConverter converter = new DSSTDSConverter(state, Propagator.DEFAULT_LAW);
