...
class NewcombOperatorTest {
    ...
    void recursionTest() {
        ...
        for (int n = 2; n < 10; n++) {
            ...
            for (int s = 0; s < 10; s++) {
                ...
                assertEquals(newcalc21, newcomb21, 1.e-14);
                ...
                assertEquals(newcalc12, newcomb12, 1.e-14);
                ...
                assertEquals(newcalc22, newcomb22, 1.e-14);
            }
        }
    }
    ...
    void valueRefTest() {
        ...
        assertEquals(90061805802.16286, value, 0.1);
    }
