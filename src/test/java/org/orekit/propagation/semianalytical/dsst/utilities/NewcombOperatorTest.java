...
public class NewcombOperatorTest {
    ...
    public void recursionTest() {
        ...
        for (int n = 2; n < 10; n++) {
            ...
            for (int s = 0; s < 10; s++) {
                ...
                Assertions.assertEquals(newcalc21, newcomb21, 1.e-14);
                ...
                Assertions.assertEquals(newcalc12, newcomb12, 1.e-14);
                ...
                Assertions.assertEquals(newcalc22, newcomb22, 1.e-14);
            }
        }
    }
    ...
    public void valueRefTest() {
        ...
        Assertions.assertEquals(value, 90061805802.16286, 0.1);
    }
