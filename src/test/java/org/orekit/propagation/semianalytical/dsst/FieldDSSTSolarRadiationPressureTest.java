...
public class FieldDSSTSolarRadiationPressureTest {
    ...
    private <T extends CalculusFieldElement<T>> void doTestGetMeanElementRate(final Field<T> field) {
        ...
        Assertions.assertEquals(6.839604358256296E-8,    elements[0].getReal(), 1.0e-23);
        Assertions.assertEquals(-2.99094421615493E-11,   elements[1].getReal(), 1.0e-27);
        Assertions.assertEquals(-2.5384005619142134E-10, elements[2].getReal(), 1.0e-26);
        Assertions.assertEquals(2.0378279596707678E-13,  elements[3].getReal(), 1.0e-29);
        Assertions.assertEquals(-2.3338772015159737E-14, elements[4].getReal(), 1.0e-30);
        Assertions.assertEquals(1.6082383581034497E-11,  elements[5].getReal(), 1.0e-27);
    ...
    private <T extends CalculusFieldElement<T>> void doTestShortPeriodTerms(final Field<T> field) {
        ...
        Assertions.assertEquals(-2.567333228302908E-10, y[1].getReal(), 1.0e-25);
        Assertions.assertEquals(-3.849598776918734E-9,  y[2].getReal(), 1.0e-24);
        Assertions.assertEquals(-3.069285299519464E-9,  y[3].getReal(), 1.0e-24);
        Assertions.assertEquals(-4.90887054227722E-9,   y[4].getReal(), 1.0e-23);
        Assertions.assertEquals(-2.3854933842837777E-9, y[5].getReal(), 1.0e-25);
    }
