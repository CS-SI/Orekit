...
class MaxGapInterpolationGridTest {

    @Test
    void testComputeGridPoints() {
        // Initialize
        final MaxGapInterpolationGrid grid = new MaxGapInterpolationGrid(50.0);
        // Action
        final double[] gridPoints = grid.getGridPoints(100.0, 200.0);
        // Verify
        Assertions.assertEquals(2, gridPoints.length);
        Assertions.assertEquals(100.0, gridPoints[0], 1e-10);
        Assertions.assertEquals(200.0, gridPoints[1], 1e-10);
    }
    ...
    void testComputeGridPointsField() {
        ...
        Assertions.assertEquals(200.0, gridPoints[1].getReal(), 1e-10);
    }
