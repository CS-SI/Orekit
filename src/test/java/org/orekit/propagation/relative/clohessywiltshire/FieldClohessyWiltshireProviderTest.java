...
public class FieldClohessyWiltshireProviderTest {
    ...
    @Test
    public void fieldClohessyWiltshireProviderTest(){
        ...
        final ClohessyWiltshireProvider cwProvider = new ClohessyWiltshireProvider(targetOrbit, chaserTimePV, eme2000, "Clohessy-Wiltshire Equations");
        ...
        Assertions.assertEquals(chaserFinalCW[0],chaserFinalCWField[0].getReal(),NUMERICAL_TOLERANCE);
        Assertions.assertEquals(chaserFinalCW[1],chaserFinalCWField[1].getReal(),NUMERICAL_TOLERANCE);
        Assertions.assertEquals(chaserFinalCW[2],chaserFinalCWField[2].getReal(),NUMERICAL_TOLERANCE);
        Assertions.assertEquals(chaserFinalCW[3],chaserFinalCWField[3].getReal(),NUMERICAL_TOLERANCE);
        Assertions.assertEquals(chaserFinalCW[4],chaserFinalCWField[4].getReal(),NUMERICAL_TOLERANCE);
        Assertions.assertEquals(chaserFinalCW[5],chaserFinalCWField[5].getReal(),NUMERICAL_TOLERANCE);
    ...
    public void testSetInitialChaserPVTLof(){
        ...
        final KeplerianOrbit targetOrbit = new KeplerianOrbit(10000,0,0,0,0,0,PositionAngleType.TRUE,eme2000,date,Constants.EIGEN5C_EARTH_MU);
        final FieldKeplerianOrbit<Binary64> targetOrbitField = new FieldKeplerianOrbit<>(field,targetOrbit);
        final TimeStampedPVCoordinates pvt1 = new TimeStampedPVCoordinates(date,Vector3D.ZERO,Vector3D.ZERO);
        final TimeStampedFieldPVCoordinates<Binary64> pvt1Field = new TimeStampedFieldPVCoordinates<>(field,pvt1);
        final FieldClohessyWiltshireProvider<Binary64> provider = new FieldClohessyWiltshireProvider<>(targetOrbitField,pvt1Field,string);
    ...
    public void extractChaserPVTTest(){
        ...
        final LocalOrbitalFrame targetLofCW = new LocalOrbitalFrame(targetOrbitField.getFrame(), LOFType.QSW, targetOrbit, "QSW LOF target");
        ...
        final TimeStampedFieldPVCoordinates<Binary64> chaserInertialWithExtract = cwProviderField.extractChaserPVT(finalTargetStateField,eme2000);
    ...
    public void getTargetOrbitTest() {
        ...
        Assertions.assertEquals(targetOrbit.getA(),orbit.getA().getReal(),NUMERICAL_TOLERANCE);
        Assertions.assertEquals(targetOrbit.getE(),orbit.getE().getReal(),NUMERICAL_TOLERANCE);
        Assertions.assertEquals(targetOrbit.getI(),orbit.getI().getReal(),NUMERICAL_TOLERANCE);
