...
public class FieldClohessyWiltshireManeuverTest {
    ...
    public void rdvManeuverTest() {
        ...
        // Target's QSW LOF
        final LocalOrbitalFrame targetLOF = new LocalOrbitalFrame(targetOrbit.getFrame(), LOFType.QSW, new KeplerianPropagator(fieldTargetOrbit.toOrbit()), "QSW LOF");
        ...
        final FieldClohessyWiltshireProvider<Binary64> cwProvider = new FieldClohessyWiltshireProvider<>(fieldTargetOrbit,pvtFieldChaserInitial);
        ...
        final FieldTwoImpulseTransfer<Binary64> cwRdv = (new FieldClohessyWiltshireRendezVous<Binary64>()).computeRendezVous(pvtFieldChaserInitial, pvtFieldChaserFinal, targetLOF, fieldTargetOrbit);
        ...
        final FieldClohessyWiltshireManeuver<Binary64> maneuver1 = new FieldClohessyWiltshireManeuver<>(firstImpulseTrigger,deltaV1,cwProvider);
        final FieldClohessyWiltshireManeuver<Binary64> maneuver2 = new FieldClohessyWiltshireManeuver<>(secondImpulseTrigger,deltaV2,cwProvider);
