...
public class ClohessyWiltshireManeuverTest {
...
// At the end of the propagation, i.e. one second after second maneuver, the chaser spacecraft relative position must be (0,0,0) and the relative velocity must be (0.,0.,0.).
    ...
    public void rdvManeuverTest() {
        ...
        final TimeStampedPVCoordinates pvtChaserInitialInert = targetLof.getTransformTo(FramesFactory.getEME2000(),epoch).transformPVCoordinates(pvtChaserInitial);
        final ClohessyWiltshireProvider cwProvider = new ClohessyWiltshireProvider(targetOrbit,pvtChaserInitialInert,FramesFactory.getEME2000());
        ...
        final TwoImpulseTransfer cwRDV = ClohessyWiltshireRendezVous.computeRendezVous(pvtChaserInitial,pvtChaserFinal,targetLof,targetOrbit);
        ...
        final ClohessyWiltshireManeuver maneuver1 = new ClohessyWiltshireManeuver(firstImpulseTrigger,deltaV1,cwProvider);

        final ClohessyWiltshireManeuver maneuver2 = new ClohessyWiltshireManeuver(secondImpulseTrigger,deltaV2,cwProvider);
