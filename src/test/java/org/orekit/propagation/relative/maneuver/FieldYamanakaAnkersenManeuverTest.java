...
class FieldYamanakaAnkersenManeuverTest {
    ...
    void rdvManeuverTest() {
        ...
        final FieldYamanakaAnkersenProvider<Binary64> yaProvider =
                        new FieldYamanakaAnkersenProvider<>(fieldTargetOrbit, pvtFieldChaserInitial);
        ...
        final FieldTwoImpulseTransfer<Binary64> yaRdv =
                        (new FieldYamanakaAnkersenRendezVous<Binary64>()).computeRendezVous(pvtFieldChaserInitial,
                                                                                            pvtFieldChaserFinal,
                                                                                            targetLof, fieldTargetOrbit,
                                                                                            new FieldKeplerianPropagator<>(
                                                                                                            fieldTargetOrbit));

        final FieldEventDetector<Binary64> firstImpulseTrigger =
                        new FieldDateDetector<>(firstImpulseDate.shiftedBy(1e-12));
        ...
        final FieldYamanakaAnkersenManeuver<Binary64> maneuver1 =
                        new FieldYamanakaAnkersenManeuver<>(firstImpulseTrigger, deltaV1, yaProvider);
        final FieldYamanakaAnkersenManeuver<Binary64> maneuver2 =
                        new FieldYamanakaAnkersenManeuver<>(secondImpulseTrigger, deltaV2, yaProvider);
        ...
        Assertions.assertEquals(0, finalChaser[0].getReal(), 7.423e-8);
        Assertions.assertEquals(0, finalChaser[1].getReal(), 4.949e-10);
        Assertions.assertEquals(0, finalChaser[2].getReal(), 1.558e-9);
