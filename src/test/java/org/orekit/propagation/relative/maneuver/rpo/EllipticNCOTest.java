...
public class EllipticNCOTest {
    ...
    public void computeChaserOrbitTest() {
        ...
        final KeplerianOrbit chaserOrbit1 = EllipticNCO.computeChaserOrbit(targetOrbit1, 50, 10, 10, 50, 0.5);
        ...
        KeplerianOrbit chaserOrbit2 = EllipticNCO.computeChaserOrbit(targetOrbit2, 50, 10, 10, 50, 1.2);
        ...
        KeplerianOrbit chaserOrbit3 = EllipticNCO.computeChaserOrbit(targetOrbit3, 50, 10, 10, 50, 2.5);
        ...
        KeplerianOrbit chaserOrbit4 = EllipticNCO.computeChaserOrbit(targetOrbit4, 50, 10, 10, 50, 3.5);
    ...
    public void CoEllipticOrbitWithoutManeuver() {
        ...
        final KeplerianOrbit chaserOrbit = EllipticNCO.computeChaserOrbit(targetOrbit, 100, 0, 0, 0, 0);
    ...
    @Test
    public void transferToEllipticOrbit() {
        double rTarget = 40000e3;
        final AbsoluteDate epoch = AbsoluteDate.J2000_EPOCH;
        // Target's orbit.
        final KeplerianOrbit targetOrbit = new KeplerianOrbit(rTarget, 0., 0.,
                ...
                PositionAngleType.TRUE, PositionAngleType.TRUE,
                FramesFactory.getGCRF(), epoch, Constants.EIGEN5C_EARTH_MU);
        // Initial TimeStampedPVCoordinates of the chaser.
        final TimeStampedPVCoordinates pvtChaserInitial = new TimeStampedPVCoordinates(new AbsoluteDate(2000, 1, 1, 11, 58, 55.816, TimeScalesFactory.getUTC()), new Vector3D(-1000, 0, 0), new Vector3D(0, 0, 0));
        final AbsoluteDate injectionDate = epoch.shiftedBy(1000);
        // Compute the chaser PVT at injection.
        final List<TimeStampedPVCoordinates> injectionWaypoints = EllipticNCO.createNaturalCircumnavigationWaypoints(new KeplerianPropagator(targetOrbit), injectionDate, 100, 0,0,0,0,1);
        // Define target propagator and chaser Data Provider.
        final KeplerianPropagator targetPropagator = new KeplerianPropagator(targetOrbit);
        ...
        // Compute waypoints to go linearly to the injection waypoint.
        final List<TimeStampedPVCoordinates> waypoints = RPOModel.YA.computeLinearWaypoints(pvtChaserInitial,new TimeStampedPVCoordinates(injectionDate,injectionWaypoints.get(0).getPosition(),Vector3D.ZERO),6);
        ...
        // Add all the maneuvers of the linear transfer.
        ...
        // Compute the final maneuver at the injection Date.
        final YamanakaAnkersenManeuver lastmaneuver = EllipticNCO.computeRelativeInjectionManeuver(waypoints.get(waypoints.size()-1), injectionWaypoints.get(0), yaProvider);
        targetPropagator.addEventDetector(lastmaneuver);

        final SpacecraftState targetEnd = targetPropagator.propagate(injectionDate.shiftedBy(targetOrbit.getKeplerianPeriod()));
        final double[] chaserEnd = yaProvider.getAdditionalData(targetEnd);

        Assertions.assertEquals(injectionWaypoints.get(0).getPosition().getX(),chaserEnd[0],1e-2);
        Assertions.assertEquals(injectionWaypoints.get(0).getPosition().getY(),chaserEnd[1],1e-2);
        Assertions.assertEquals(injectionWaypoints.get(0).getPosition().getZ(),chaserEnd[2],1e-2);
    ...
    public void computeFieldChaserOrbitTest() {
        ...
        final FieldKeplerianOrbit<Binary64> chaserOrbit1 = EllipticNCO.computeChaserOrbit(targetOrbit1, new Binary64(50), new Binary64(10), new Binary64(10), new Binary64(50), new Binary64(0.5));
        ...
        FieldKeplerianOrbit<Binary64> chaserOrbit2 = EllipticNCO.computeChaserOrbit(targetOrbit2, new Binary64(50), new Binary64(10), new Binary64(10), new Binary64(50), new Binary64(1.2));
        ...
        FieldKeplerianOrbit<Binary64> chaserOrbit3 = EllipticNCO.computeChaserOrbit(targetOrbit3, new Binary64(50), new Binary64(10), new Binary64(10), new Binary64(50), new Binary64(2.5));
        ...
        FieldKeplerianOrbit<Binary64> chaserOrbit4 = EllipticNCO.computeChaserOrbit(targetOrbit4, new Binary64(50), new Binary64(10), new Binary64(10), new Binary64(50), new Binary64(3.5));
    ...
    public void FieldCoEllipticOrbitWithoutManeuver() {
        ...
        final FieldKeplerianOrbit<Binary64> chaserOrbit = EllipticNCO.computeChaserOrbit(targetOrbit, new Binary64(100), new Binary64(0), new Binary64(0), new Binary64(0), new Binary64(0));
    ...
    @Test
    public void transferToEllipticOrbitField() {
        final Binary64Field field = Binary64Field.getInstance();
        Binary64 rTarget = new Binary64(40000e3);
        final FieldAbsoluteDate<Binary64> epoch = new FieldAbsoluteDate<>(field, AbsoluteDate.J2000_EPOCH);
        // Target's orbit.
        final FieldKeplerianOrbit<Binary64> targetOrbit = new FieldKeplerianOrbit<>(rTarget, new Binary64(0.), new Binary64(0.),
                new Binary64(0.0), new Binary64(0.0), new Binary64(0.),
                PositionAngleType.TRUE, PositionAngleType.TRUE,
                FramesFactory.getGCRF(), epoch, new Binary64(Constants.EIGEN5C_EARTH_MU));
        // Initial TimeStampedPVCoordinates of the chaser.
        final TimeStampedFieldPVCoordinates<Binary64> pvtChaserInitial = new TimeStampedFieldPVCoordinates<>(new FieldAbsoluteDate<>(field,new AbsoluteDate(2000, 1, 1, 11, 58, 55.816, TimeScalesFactory.getUTC())), new FieldPVCoordinates<>(field, new PVCoordinates(new Vector3D(-1000, 0, 0), new Vector3D(0, 0, 0))));
        final FieldAbsoluteDate<Binary64> injectionDate = epoch.shiftedBy(1000);
        // Compute the chaser PVT at injection.
        final List<TimeStampedFieldPVCoordinates<Binary64>> injectionWaypoints = EllipticNCO.createNaturalCircumnavigationWaypoints(new FieldKeplerianPropagator<>(targetOrbit), injectionDate, new Binary64(100), new Binary64(0),new Binary64(0),new Binary64(0),new Binary64(0),1);
        // Define target propagator and chaser Data Provider.
        final FieldKeplerianPropagator<Binary64> targetPropagator = new FieldKeplerianPropagator<>(targetOrbit);
        final FieldYamanakaAnkersenProvider<Binary64> yaProvider = new FieldYamanakaAnkersenProvider<>(targetOrbit, pvtChaserInitial);
        targetPropagator.addAdditionalDataProvider(yaProvider);
        // Compute waypoints to go linearly to the injection waypoint.
        final List<TimeStampedFieldPVCoordinates<Binary64>> waypoints = RPOModel.YA.computeLinearWaypoints(pvtChaserInitial,new TimeStampedFieldPVCoordinates<>(injectionDate,new FieldPVCoordinates<>(injectionWaypoints.get(0).getPosition(),new FieldVector3D<>(field,Vector3D.ZERO))),6);
        final FieldMultiRelativeTransfersYA<Binary64> multiRelativeTransfersYA = new FieldMultiRelativeTransfersYA<>(waypoints, targetOrbit, new FieldKeplerianPropagator<>(targetOrbit));
        // Add all the maneuvers of the linear transfer.
        final List<FieldYamanakaAnkersenManeuver<Binary64>> maneuvers = multiRelativeTransfersYA.computeRelativeManeuvers(yaProvider);
        for (FieldYamanakaAnkersenManeuver<Binary64> maneuver: maneuvers) {
            targetPropagator.addEventDetector(maneuver);
        }
        // Compute the final maneuver at the injection Date.
        final FieldYamanakaAnkersenManeuver<Binary64> lastmaneuver = EllipticNCO.computeRelativeInjectionManeuver(waypoints.get(waypoints.size()-1), injectionWaypoints.get(0), yaProvider);
        targetPropagator.addEventDetector(lastmaneuver);

        final FieldSpacecraftState<Binary64> targetEnd = targetPropagator.propagate(injectionDate.shiftedBy(targetOrbit.getKeplerianPeriod()));
        final Binary64[] chaserEnd = yaProvider.getAdditionalData(targetEnd);

        Assertions.assertEquals(injectionWaypoints.get(0).getPosition().getX().getReal(),chaserEnd[0].getReal(),1e-2);
        Assertions.assertEquals(injectionWaypoints.get(0).getPosition().getY().getReal(),chaserEnd[1].getReal(),1e-2);
        Assertions.assertEquals(injectionWaypoints.get(0).getPosition().getZ().getReal(),chaserEnd[2].getReal(),1e-2);
