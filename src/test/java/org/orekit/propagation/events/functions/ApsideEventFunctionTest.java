...
class ApsideEventFunctionTest {
    ...
    void testZero() {
        ...
        // WHEN
        final double g = apsideEventFunction.value(state);
        // THEN
        assertEquals(0., g);
    }
    ...
    void testValueField() {
        ...
        final ApsideEventFunction apsideEventFunction = new ApsideEventFunction();
        // WHEN
        final Binary64 g = apsideEventFunction.value(fieldSpacecraftState);
        // THEN
        assertEquals(apsideEventFunction.value(state), g.getReal());
    }
}
