...
class MaskedElevationEventFunctionTest {
    ...
    void testValueConstant() {
        ...
        final double[][] maskArray = new double[2][2];
        final ElevationMask mask = new ElevationMask(maskArray);
        final MaskedElevationEventFunction eventFunction = new MaskedElevationEventFunction(null, frame, mask);
    ...
    void testValueField() {
        ...
        maskArray[0][1] = 2.;
        final ElevationMask mask = new ElevationMask(maskArray);
        final MaskedElevationEventFunction eventFunction = new MaskedElevationEventFunction(model, frame, mask);
        final SpacecraftState state = new SpacecraftState(TestUtils.getDefaultOrbit(AbsoluteDate.ARBITRARY_EPOCH));
