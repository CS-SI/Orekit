...
class FieldLatitudeExtremumDetectorTest {
    ...
    void testCreate() {
        ...
        final FieldLatitudeExtremumDetector<Binary64> fieldDetector = new FieldLatitudeExtremumDetector<>(field,
                ellipsoid);
        ...
        // WHEN
        final FieldLatitudeExtremumDetector<Binary64> newDetector = fieldDetector.create(fieldEventDetectionSettings,
                fieldHandler);
        // THEN
    ...
    void testG() {
        ...
        // THEN
        final double expectedG = new LatitudeExtremumDetector(ellipsoid).g(state);
    ...
    void testDetection() {
        ...
        final FieldLatitudeExtremumDetector<Binary64> fieldDetector = new FieldLatitudeExtremumDetector<>(field,
                ellipsoid);
        final Orbit orbit = new KeplerianOrbit(6800e3, 0.001, 0.1, 0, 0, 0, PositionAngleType.MEAN, FramesFactory.getGCRF(),
        ...
        final LatitudeExtremumDetector latitudeExtremumDetector = new LatitudeExtremumDetector(ellipsoid);
