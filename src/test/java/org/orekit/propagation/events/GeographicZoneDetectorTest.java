...
public class GeographicZoneDetectorTest {
    ...
    public void testFrance() throws OrekitException {
        ...
        SphericalPolygonsSet zone = (SphericalPolygonsSet) new RegionFactory<Sphere2D>().union(continental, corsica);

        GeographicZoneDetector d = new GeographicZoneDetector(20.0, 1.e-3, earth, zone, FastMath.toRadians(0.5)).
