...
public abstract class CloseEventsAbstractTest {
    ...
    public void testCloseEventsFirstOneIsReset() {
        ...
        Assertions.assertEquals(t1, events.getFirst().getState().getDate().durationFrom(epoch), 0.0);
    ...
    public void testCloseEvents() {
        ...
        Assertions.assertEquals(5, events.getFirst().getState().getDate().durationFrom(epoch), tolerance);
        Assertions.assertEquals(detector1, events.getFirst().getDetector());
    ...
    public void testSimultaneousEvents() {
        ...
        Assertions.assertEquals(5, events1.getFirst().getState().getDate().durationFrom(epoch), 0.0);
        List<Event> events2 = handler2.getEvents();
        Assertions.assertEquals(1, events2.size());
        Assertions.assertEquals(5, events2.getFirst().getState().getDate().durationFrom(epoch), 0.0);
    }
    ...
    public void testSimultaneousEventsReset() {
        ...
        Assertions.assertEquals(5, events.getFirst().getState().getDate().durationFrom(epoch), 0.0);
    ...
    public void testSimultaneousDiscontinuousEventsAfterReset() {
        ...
        // verify
        Assertions.assertEquals(t, events.getFirst().getState().getDate().durationFrom(epoch), tol);
        Assertions.assertTrue(events.getFirst().isIncreasing());
    ...
    public void testFastSwitching() {
        ...
        Assertions.assertEquals(1, events1.size());
        Assertions.assertEquals(9.9, events1.getFirst().getState().getDate().durationFrom(epoch), 0.1);
    ...
    public void testTrickyCaseLower() {
        ...
        Assertions.assertEquals(t1, events.getFirst().getState().getDate().durationFrom(epoch), tolerance);
    ...
    public void testRootFindingTolerance() {
        ...
        Assertions.assertEquals(2, events.size());
        Assertions.assertEquals(t3, events.getFirst().getState().getDate().durationFrom(epoch), 0.5);
        Assertions.assertTrue(events.getFirst().isIncreasing());
    ...
    public void testRootPlusToleranceHasWrongSign() {
        ...
        Assertions.assertEquals(t1, events.getFirst().getState().getDate().durationFrom(epoch), toleranceB);
        Assertions.assertTrue(events.getFirst().isIncreasing());
        Assertions.assertSame(detectorB, events.getFirst().getDetector());
    ...
    public void testToleranceMaxIterations() {
        ...
        Assertions.assertEquals(t1.durationFrom(epoch),
                events.getFirst().getState().getDate().durationFrom(epoch), tolerance);
        Assertions.assertTrue(events.getFirst().isIncreasing());
        Assertions.assertSame(detectorA, events.getFirst().getDetector());
    }
    ...
    public void testEventStepHandler() {
        ...
        OrekitStepInterpolator interpolator = stepHandler.interpolators.getFirst();
        Assertions.assertEquals(0.0,
    ...
    public void testCloseEventsFirstOneIsResetReverse() {
        ...
        List<Event> events1 = handler1.getEvents();
        Assertions.assertEquals(1, events1.size());
        Assertions.assertEquals(t1, events1.getFirst().getState().getDate().durationFrom(epoch), 0.0);
        List<Event> events2 = handler2.getEvents();
    ...
    public void testCloseEventsReverse() {
        ...
        List<Event> events1 = handler1.getEvents();
        Assertions.assertEquals(1, events1.size());
        Assertions.assertEquals(-5, events1.getFirst().getState().getDate().durationFrom(epoch), tolerance);
        List<Event> events2 = handler2.getEvents();
        Assertions.assertEquals(1, events2.size());
        Assertions.assertEquals(-5.5, events2.getFirst().getState().getDate().durationFrom(epoch), tolerance);
    }
    ...
    public void testFastSwitchingReverse() {
        ...
        // finds one or three events. Not 2.
        Assertions.assertEquals(1, events.size());
        Assertions.assertEquals(-9.9, events.getFirst().getState().getDate().durationFrom(epoch), 0.2);
        Assertions.assertTrue(events.getFirst().isIncreasing());
    }
    ...
    public void testToleranceMaxIterationsReverse() {
        ...
        // use root finder tolerance instead of event finder tolerance.
        Assertions.assertEquals(t1.durationFrom(epoch),
                events.getFirst().getState().getDate().durationFrom(epoch),
                FastMath.ulp(-15.0));
        Assertions.assertTrue(events.getFirst().isIncreasing());
        Assertions.assertSame(detectorA, events.getFirst().getDetector());
    }
    ...
    protected static class TimeDetector extends AbstractDetector<TimeDetector> {
        ...
        public TimeDetector(double... eventTs) {
            this(EventDetectionSettings.getDefaultEventDetectionSettings(), new StopOnEvent(), toDates(eventTs));
        }
        ...
        public TimeDetector(AbsoluteDate... eventTs) {
            this(EventDetectionSettings.getDefaultEventDetectionSettings(), new StopOnEvent(), Arrays.asList(eventTs));
        }

        private TimeDetector(EventDetectionSettings detectionSettings, EventHandler newHandler,
        ...
        @Override
        protected TimeDetector create(EventDetectionSettings detectionSettings,
                                      EventHandler newHandler) {
            return new TimeDetector(detectionSettings, newHandler, eventTs);
        }
    ...
    private static class FlatDetector extends AbstractDetector<FlatDetector> {
        ...
        public FlatDetector(double... eventTs) {
            this(EventDetectionSettings.getDefaultEventDetectionSettings(),
        ...
        private FlatDetector(EventDetectionSettings detectionSettings,
                             EventHandler newHandler,
                             EventDetector g) {
            super(detectionSettings, newHandler);
            this.g = g;
        ...
        @Override
        protected FlatDetector create(EventDetectionSettings detectionSettings,
                                      EventHandler newHandler) {
            return new FlatDetector(detectionSettings, newHandler, g);
        }
    ...
    private static class ContinuousDetector extends AbstractDetector<ContinuousDetector> {
        ...
        private ContinuousDetector(EventDetectionSettings detectionSettings,
                                   EventHandler newHandler,
        ...
        @Override
        protected ContinuousDetector create(EventDetectionSettings detectionSettings,
                EventHandler newHandler) {
            return new ContinuousDetector(detectionSettings, newHandler, eventTs);
        }
    ...
    private class ResetChangesSignGenerator extends AbstractDetector<ResetChangesSignGenerator> {
        ...
        private ResetChangesSignGenerator(final EventDetectionSettings eventDetectionSettings,
        ...
        protected ResetChangesSignGenerator create(final EventDetectionSettings detectionSettings,
                                                   final EventHandler newHandler) {
            return new ResetChangesSignGenerator(detectionSettings, newHandler,
                                                 t0, y1, y2, change);
        }
