...
class AdamsMoultonFieldIntegratorBuilderTest {
    ...
    void testBuildIntegrator() {
        ...
        final int nSteps = 2;
        // WHEN
        final AdamsMoultonFieldIntegratorBuilder<Binary64> builder = new AdamsMoultonFieldIntegratorBuilder<>(nSteps, minStep,
        ...
        // THEN
        Assertions.assertInstanceOf(AdamsMoultonFieldIntegrator.class, integrator);
    }
    ...
    void testToODEIntegratorBuilder() {
        ...
        final ToleranceProvider mockedProvider = Mockito.mock(ToleranceProvider.class);
        final int nSteps = 2;
        final AdamsMoultonFieldIntegratorBuilder<Binary64> fieldIntegratorBuilder = new AdamsMoultonFieldIntegratorBuilder<>(nSteps, 1,
                2., mockedProvider);
        // WHEN
        final AdamsMoultonIntegratorBuilder integratorBuilder = fieldIntegratorBuilder.toODEIntegratorBuilder();
        // THEN
