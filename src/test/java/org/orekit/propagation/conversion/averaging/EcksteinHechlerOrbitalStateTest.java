...
class EcksteinHechlerOrbitalStateTest {
    ...
    void testToOsculating() {
        ...
        // THEN
        assertEquals(averagedState.getDate(), circularOrbit.getDate());
    ...
    private void compareOrbitalElements(final AveragedCircularWithMeanAngle elements,
        ...
        assertEquals(elements.getAveragedSemiMajorAxis(), circularOrbit.getA(), 1e4);
        assertEquals(elements.getAveragedCircularEx(), circularOrbit.getCircularEx(), 1e-3);
        assertEquals(elements.getAveragedCircularEy(), circularOrbit.getCircularEy(), 1e-3);
        assertEquals(elements.getAveragedInclination(), circularOrbit.getI(), 1e-3);
        assertEquals(elements.getAveragedRightAscensionOfTheAscendingNode(),
                circularOrbit.getRightAscensionOfAscendingNode(), 1e-3);
        assertEquals(elements.getAveragedMeanLatitudeArgument(),
