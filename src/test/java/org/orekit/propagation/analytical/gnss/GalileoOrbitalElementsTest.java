...
public class GalileoOrbitalElementsTest {

    @Test
    public void testDefaultMethods() {
        GalileoOrbitalElements goe = new GalileoOrbitalElements() {
        ...
        Assert.assertEquals(0,   goe.getIODNav());
        ...
        Assert.assertEquals(0.0, goe.getBGD(),      Precision.SAFE_MIN);
        Assert.assertEquals(0.0, goe.getBGDE1E5a(), Precision.SAFE_MIN);
        Assert.assertEquals(0.0, goe.getBGDE5bE1(), Precision.SAFE_MIN);
