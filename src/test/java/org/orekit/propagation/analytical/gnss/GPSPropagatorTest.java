...
public class GPSPropagatorTest {
	...
	public void testDerivativesConsistency() {
		...
		for (final GPSAlmanac almanac : almanacs) {
			...
			AbsoluteDate t0 = new GNSSDate(elements.getWeek(), 0.001 * elements.getTime(), SatelliteSystem.GPS)
					.getDate();
			for (double dt = 0; dt < Constants.JULIAN_DAY; dt += 600) {
	...
	public void testPosition() {
		...
		GPSOrbitalElements goe = new GPSEphemeris(7, 0, 288000, 5153.599830627441, 0.012442796607501805,
				4.419469802942352E-9, 0.9558937988021613, -2.4608167886110235E-10, 1.0479401362158658,
				-7.967117576712062E-9, -2.4719019944000538, -1.0899023379614294, 4.3995678424835205E-6,
				1.002475619316101E-5, 183.40625, 87.03125, 3.203749656677246E-7, 4.0978193283081055E-8);
	...
	private class GPSEphemeris implements GPSOrbitalElements {
		 ...
		 */
		GPSEphemeris(int prn, int week, double toe, double sqa, double ecc, double deltaN, double inc, double iDot,
