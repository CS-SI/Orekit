...
public class BeidouOrbitalElementsTest {

    @Test
    public void testDefaultMethods() {
        BeidouOrbitalElements boe = new BeidouOrbitalElements() {
        ...
        Assert.assertEquals(0,   boe.getAODC());
        Assert.assertEquals(0,   boe.getAODE());
        Assert.assertEquals(0,   boe.getIOD());
        Assert.assertEquals(0.0, boe.getAf0(),  Precision.SAFE_MIN);
        Assert.assertEquals(0.0, boe.getAf1(),  Precision.SAFE_MIN);
        Assert.assertEquals(0.0, boe.getAf2(),  Precision.SAFE_MIN);
        Assert.assertEquals(0.0, boe.getToc(),  Precision.SAFE_MIN);
        Assert.assertEquals(0.0, boe.getTGD1(), Precision.SAFE_MIN);
        Assert.assertEquals(0.0, boe.getTGD2(), Precision.SAFE_MIN);
