...
/** Logger for position only measurements.
 * @author Luc Maisonobe
 */
class PositionOnlyLog extends MeasurementLog<Position> {

    /** {@inheritDoc} */
    @Override
    double residual(final EstimatedMeasurement<Position> evaluation) {
