...
public class KeplerianRangeRateMeasurementCreator extends MeasurementCreator {

    private final KeplerianContext context;
    private final boolean twoWay;
    private final ObservableSatellite satellite;

    public KeplerianRangeRateMeasurementCreator(final KeplerianContext context, boolean twoWay,
