...
public class KeplerianRangeMeasurementCreator extends MeasurementCreator {

    private final KeplerianContext    context;
    private final Vector3D            antennaPhaseCenter;
    private final double              clockOffset;
    private final ObservableSatellite satellite;

    public KeplerianRangeMeasurementCreator(final KeplerianContext context) {
        this(context, Vector3D.ZERO, 0.0);
    }

    public KeplerianRangeMeasurementCreator(final KeplerianContext context, final Vector3D antennaPhaseCenter,
