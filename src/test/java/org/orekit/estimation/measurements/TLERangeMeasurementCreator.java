...
public class TLERangeMeasurementCreator extends MeasurementCreator {

    private final TLEContext         context;
    private final Vector3D            antennaPhaseCenter;
    private final double              clockOffset;
    private final ObservableSatellite satellite;

    public TLERangeMeasurementCreator(final TLEContext context) {
        this(context, Vector3D.ZERO, 0.0);
    }

    public TLERangeMeasurementCreator(final TLEContext context, final Vector3D antennaPhaseCenter,
