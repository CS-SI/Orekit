...
class RelativisticClockInterSatellitesOneWayRangeRateModifierTest {
    ...
    void testRelativisticClockCorrection() {
        ...
        final InterSatellitesOneWayRangeRate range = new InterSatellitesOneWayRangeRate(new ObservableSatellite(0),
        ...
        final EstimationModifier<InterSatellitesOneWayRangeRate> modifier =
            new RelativisticClockInterSatellitesOneWayRangeRateModifier(Constants.EIGEN5C_EARTH_MU);
        range.addModifier(modifier);
        final EstimatedMeasurement<InterSatellitesOneWayRangeRate> estimatedAfter = range.estimate(0, 0, states);
