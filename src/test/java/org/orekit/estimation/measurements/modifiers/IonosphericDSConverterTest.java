...
public class IonosphericDSConverterTest {
    ...
    public void testConversion() {
        ...
        // Model
        SingleLayerModelMappingFunction mFunction = new SingleLayerModelMappingFunction();
        EstimatedIonosphericModel model = new EstimatedIonosphericModel(mFunction, 10.0);
        ...
        FieldSpacecraftState<DerivativeStructure> dsState = converter.getState(model);
        DerivativeStructure[] parameters = converter.getParameters(dsState, model);
