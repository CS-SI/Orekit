...
class OnBoardAntennaInterSatellitesPhaseModifierTest {
    ...
    void testPreliminary() {
        ...
        for (int i = 0; i < spacecraftCenteredMeasurements.size(); ++i) {
            ...
            assertTrue((ar.getObservedValue()[0] - sr.getObservedValue()[0]) * RADIO_WAVE.getWavelength() >= -1.0);
            assertTrue((ar.getObservedValue()[0] - sr.getObservedValue()[0]) * RADIO_WAVE.getWavelength() <= -0.36);
        }
    }
    ...
    void testEffect() {
        ...
        for (int i = 0; i < spacecraftCenteredMeasurements.size(); ++i) {
            ...
            InterSatellitesPhase ar = (InterSatellitesPhase) antennaCenteredMeasurements.get(i);
            assertEquals(0.0, sr.getDate().durationFrom(ar.getDate()), 2.0e-8);
            assertEquals(ar.getObservedValue()[0] * RADIO_WAVE.getWavelength(), estimated.getEstimatedValue()[0] * RADIO_WAVE.getWavelength(), 2.0e-5);
        }
