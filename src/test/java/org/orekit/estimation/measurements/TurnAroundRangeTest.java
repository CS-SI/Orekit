...
//    @Test
//    public void testValuesWithModifier() throws OrekitException {
...
//    }
    ...
    public void testStateDerivativesAnalytic() throws OrekitException {
        ...
        boolean printResults = false;
        if (printResults) {
            System.out.println("\nTest TAR State Derivatives - Analytical comparison\n");
        }
        // Run test
        boolean isModifier = false;
    ...
    public void testStateDerivativesNumeric() throws OrekitException {
        ...
        boolean printResults = false;
        if (printResults) {
            System.out.println("\nTest TAR State Derivatives - Numerical comparison\n");
        }
        // Run test
        boolean isModifier = false;
    ...
    public void testStateDerivativesWithModifierAnalytic() throws OrekitException {
        ...
        boolean printResults = false;
        if (printResults) {
            System.out.println("\nTest TAR State Derivatives with Modifier - Analytical comparison\n");
        }
        // Run test
        boolean isModifier = true;
        boolean isNumeric  = false;
    ...
    public void testStateDerivativesWithModifierNumeric() throws OrekitException {
        ...
        boolean printResults = false;
        if (printResults) {
            System.out.println("\nTest TAR State Derivatives with Modifier - Numerical comparison\n");
        }
        // Run test
        boolean isModifier = true;
        boolean isNumeric  = true;
    ...
    public void testParameterDerivativesAnalytic() throws OrekitException {
        ...
        if (printResults) {
            System.out.println("\nTest TAR Parameter Derivatives - Analytical comparison\n");
        }
        // Run test
        boolean isModifier = false;
        boolean isNumeric  = false;
    ...
    public void testParameterDerivativesNumeric() throws OrekitException {
        ...
        if (printResults) {
            System.out.println("\nTest TAR Parameter Derivatives - Numerical comparison\n");
        }
        // Run test
        boolean isModifier = false;
        boolean isNumeric  = true;
    ...
    public void testParameterDerivativesWithModifierAnalytic() throws OrekitException {
        ...
        if (printResults) {
            System.out.println("\nTest TAR Parameter Derivatives with Modifier - Analytical comparison\n");
        }
        // Run test
        boolean isModifier = true;
        boolean isNumeric  = false;
    ...
    public void testParameterDerivativesWithModifierNumeric() throws OrekitException {
        ...
        if (printResults) {
            System.out.println("\nTest TAR Parameter Derivatives with Modifier - Numerical comparison\n");
        }
        // Run test
        boolean isModifier = true;
        boolean isNumeric  = true;
...
//            }
            ...
            // Add modifier if test implies it
//            if (isModifier) {
//                final
//            }
            final double TARestimated = measurement.estimate(0, 0, state).getEstimatedValue()[0];

//            // Test: analytic version against observed value
//            final double TARestimated = ((TurnAroundRange) measurement).
    ...
    void genericTestStateDerivatives(final boolean isModifier, final boolean isNumeric, final boolean printResults)
        ...
        for (final ObservedMeasurement<?> measurement : measurements) {
            ...
            if (isNumeric) {
                ...
                final EstimatedMeasurement<TurnAroundRange> TARAnalytic = ((TurnAroundRange) measurement).theoreticalEvaluationAnalytic(0, 0, state);
                if (isModifier) {
                    modifier.modify(TARAnalytic);
                }
                jacobianRef = TARAnalytic.getStateDerivatives();
            }

            //          //Test: Test point by point with the debugger
            //          if (!isNumeric && !isModifier) {
            //              k++;
            //              System.out.println(k + "th measurement");
            //              final EstimatedMeasurement<TurnAroundRange> test =
            //                              ((TurnAroundRange) measurement).theoreticalEvaluationValidation(0, 0, state);
            //          }
            //          //Test
...
//                        modifier.modify(TARAnalytic);
//                    }
                    ref = TARAnalytic.getParameterDerivatives(drivers[i])[0];
                }
