...
public class TDOABuilderTest {
    ...
    private MeasurementBuilder<TDOA> getBuilder(final RandomGenerator random,
    ...
    private void doTest(long seed, double startPeriod, double endPeriod, double tolerance) {
        ...
        final GroundStation emitter  = context.TDOAstations.getFirst();
        final GroundStation receiver = context.TDOAstations.getSecond();
