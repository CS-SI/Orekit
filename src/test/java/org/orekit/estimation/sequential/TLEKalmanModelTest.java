...
public class TLEKalmanModelTest {

    /** Orbit type for propagation. */
    private final OrbitType orbitType = OrbitType.KEPLERIAN;
    ...
    /** Propagator builder. */
    private TLEPropagatorBuilder propagatorBuilder;
    ...
    public void setUp() {
        ...
        this.orbit0 = TLEPropagator.selectExtrapolator(context.initialTLE).getInitialState().getOrbit();
        ObservableSatellite sat = new ObservableSatellite(0);
        
        // Create propagator builder
        this.propagatorBuilder = context.createBuilder(1.0e-3, 6000.0, 10.);

        // Create PV at t0
        final AbsoluteDate date0 = context.initialTLE.getDate();
        this.pv = new PV(date0,
                             orbit0.getPVCoordinates().getPosition(),
                             orbit0.getPVCoordinates().getVelocity(),
    ...
    private double[] getParametersScale(final TLEPropagatorBuilder builder,
    ...
    private void checkModelAtT0() {
        ...
        final TLEKalmanODModel model = new TLEKalmanODModel(Arrays.asList(propagatorBuilder),
