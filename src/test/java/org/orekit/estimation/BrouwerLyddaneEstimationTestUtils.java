...
public class BrouwerLyddaneEstimationTestUtils {
    ...
    public static BrouwerLyddaneContext eccentricContext(final String dataRoot) {
     ...
     */
    public static void checkFit(final BrouwerLyddaneContext context, final BatchLSEstimator estimator,
