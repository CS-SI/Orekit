...
public class RapidDataAndPredictionXMLLoaderTest extends AbstractFilesLoaderTest {
    ...
    public void testExternalResourcesAreIgnoredIssue368() {
        ...
        RapidDataAndPredictionXMLLoader loader =
                new RapidDataAndPredictionXMLLoader("^finals2000A\\..*\\.xml$", manager);
    ...
    public void testStartDateDaily1980() {
        ...
        new RapidDataAndPredictionXMLLoader("^finals\\.daily\\.xml$", manager).fillHistory(converter, history);
    ...
    public void testStartDateDaily2000() {
        ...
        SortedSet<EOPEntry> history = new TreeSet<EOPEntry>(new ChronologicalComparator());
        new RapidDataAndPredictionXMLLoader("^finals2000A\\.daily\\.xml$", manager).fillHistory(converter, history);
    ...
    public void testStartDateFinals1980() {
        ...
        IERSConventions.NutationCorrectionConverter converter =
                IERSConventions.IERS_1996.getNutationCorrectionConverter();
        SortedSet<EOPEntry> history = new TreeSet<EOPEntry>(new ChronologicalComparator());
        new RapidDataAndPredictionXMLLoader("^finals\\.1999\\.xml$", manager).fillHistory(converter, history);
    ...
    public void testStartDateFinals2000() {
        ...
        IERSConventions.NutationCorrectionConverter converter =
                IERSConventions.IERS_2003.getNutationCorrectionConverter();
        SortedSet<EOPEntry> history = new TreeSet<EOPEntry>(new ChronologicalComparator());
        new RapidDataAndPredictionXMLLoader("^finals2000A\\.2002\\.xml$", manager).fillHistory(converter, history);
