...
public class EOPC04FilesLoaderTest extends AbstractFilesLoaderTest {
    ...
    public void testMissingMonths() {
        ...
        new EOPC04FilesLoader(FramesFactory.EOPC04_2000_FILENAME, manager).fillHistory(converter, history);
    ...
    public void testContent() {
        ...
        new EOPC04FilesLoader(FramesFactory.EOPC04_2000_FILENAME, manager).fillHistory(converter, data);
