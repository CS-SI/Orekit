...
public class BulletinAFilesLoaderTest extends AbstractFilesLoaderTest {
    ...
    public void testStartDate() {
        ...
        new BulletinAFilesLoader("bulletina-xxvi-\\d\\d\\d\\.txt", manager).fillHistory(null, history);
    ...
    public void testSingleFile() {
        ...
        new BulletinAFilesLoader("bulletina-xxvi-039.txt", manager).fillHistory(null, data);
    ...
    public void testRapidDataContent() {
        setRoot("bulletinA");
        SortedSet<EOPEntry> data = new TreeSet<EOPEntry>(new ChronologicalComparator());
        new BulletinAFilesLoader(FramesFactory.BULLETINA_FILENAME, manager).fillHistory(null, data);
        EOPHistory history = new EOPHistory(IERSConventions.IERS_2010, data, true);
    ...
    private void checkTruncated(String name, OrekitMessages expected) {
        SortedSet<EOPEntry> history = new TreeSet<EOPEntry>(new ChronologicalComparator());
        try {
            new BulletinAFilesLoader(name, manager).fillHistory(null, history);
