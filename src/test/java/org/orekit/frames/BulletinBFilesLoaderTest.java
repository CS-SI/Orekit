...
public class BulletinBFilesLoaderTest extends AbstractFilesLoaderTest {
    ...
    public void testMissingMonths() {
        ...
        new BulletinBFilesLoader(FramesFactory.BULLETINB_2000_FILENAME, manager).fillHistory(converter, history);
    ...
    public void testNewFormatNominal() {
        ...
        new BulletinBFilesLoader("^bulletinb\\.270$", manager).fillHistory(converter, data);
    ...
    public void testOldFormatContent() {
        ...
        IERSConventions.NutationCorrectionConverter converter =
                IERSConventions.IERS_2010.getNutationCorrectionConverter();
        SortedSet<EOPEntry> data = new TreeSet<EOPEntry>(new ChronologicalComparator());
        new BulletinBFilesLoader(FramesFactory.BULLETINB_2000_FILENAME, manager).fillHistory(converter, data);
        EOPHistory history = new EOPHistory(IERSConventions.IERS_2010, data, true);
    ...
    public void testOldFormat1980() {
        ...
        SortedSet<EOPEntry> data = new TreeSet<EOPEntry>(new ChronologicalComparator());
        new BulletinBFilesLoader("^bulletinb_IAU1980-220\\.txt$", manager).fillHistory(converter, data);
    ...
    public void testOldFormat1980RemovedFirstDates() {
        ...
        IERSConventions.NutationCorrectionConverter converter =
                IERSConventions.IERS_1996.getNutationCorrectionConverter();
        SortedSet<EOPEntry> data = new TreeSet<EOPEntry>(new ChronologicalComparator());
        new BulletinBFilesLoader("^bulletinb_IAU1980-220-edited\\.txt$", manager).fillHistory(converter, data);
        EOPHistory history = new EOPHistory(IERSConventions.IERS_1996, data, true);
    ...
    public void testOldFormatTruncated() {
        ...
        SortedSet<EOPEntry> data = new TreeSet<EOPEntry>(new ChronologicalComparator());
        try {
            new BulletinBFilesLoader("^bulletinb_IAU2000-216-truncated\\.txt$", manager).fillHistory(converter, data);
    ...
    public void testNewFormatRemovedFirstDates() {
        ...
        IERSConventions.NutationCorrectionConverter converter =
                IERSConventions.IERS_2010.getNutationCorrectionConverter();
        SortedSet<EOPEntry> data = new TreeSet<EOPEntry>(new ChronologicalComparator());
        new BulletinBFilesLoader("^bulletinb-edited\\.270$", manager).fillHistory(converter, data);
        EOPHistory history = new EOPHistory(IERSConventions.IERS_2010, data, true);
    ...
    public void testNewFormatTruncated() {
        ...
        IERSConventions.NutationCorrectionConverter converter =
                IERSConventions.IERS_2010.getNutationCorrectionConverter();
       SortedSet<EOPEntry> history = new TreeSet<EOPEntry>(new ChronologicalComparator());
        new BulletinBFilesLoader("^bulletinb-truncated\\.270$", manager).fillHistory(converter, history);
    }
    ...
    public void testNewFormatTruncatedEarly() {
        ...
        IERSConventions.NutationCorrectionConverter converter =
                IERSConventions.IERS_2010.getNutationCorrectionConverter();
       SortedSet<EOPEntry> history = new TreeSet<EOPEntry>(new ChronologicalComparator());
        new BulletinBFilesLoader("^bulletinb-truncated-early\\.270$", manager).fillHistory(converter, history);
    }
    ...
    public void testNewFormatInconsistent() {
        ...
        IERSConventions.NutationCorrectionConverter converter =
                IERSConventions.IERS_2010.getNutationCorrectionConverter();
       SortedSet<EOPEntry> history = new TreeSet<EOPEntry>(new ChronologicalComparator());
        new BulletinBFilesLoader("^bulletinb-inconsistent\\.270$", manager).fillHistory(converter, history);
    }
    ...
    public void testNewFormatInconsistentDate() {
       ...
       SortedSet<EOPEntry> history = new TreeSet<EOPEntry>(new ChronologicalComparator());
       try {
           new BulletinBFilesLoader("bulletinb-inconsistent-date.270", manager).fillHistory(converter, history);
