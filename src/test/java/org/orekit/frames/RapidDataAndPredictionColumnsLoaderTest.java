...
public class RapidDataAndPredictionColumnsLoaderTest extends AbstractFilesLoaderTest {
    ...
    public void testStartDateDaily1980() {
        ...
        new RapidDataAndPredictionColumnsLoader(false, "^finals\\.daily$", manager).fillHistory(converter, history);
    ...
    public void testStartDateDaily2000() {
        ...
        SortedSet<EOPEntry> history = new TreeSet<EOPEntry>(new ChronologicalComparator());
        new RapidDataAndPredictionColumnsLoader(true, "^finals\\.daily$", manager).fillHistory(converter, history);
        Assert.assertEquals(new AbsoluteDate(2011, 4, 9, TimeScalesFactory.getUTC()),
    ...
    public void testMissingColumnsPadding1980() {
        ...
        new RapidDataAndPredictionColumnsLoader(false, "^finals\\.daily$", manager).fillHistory(converter, data);
    ...
    public void testMissingColumnsPadding2000() {
        ...
        IERSConventions.NutationCorrectionConverter converter =
                IERSConventions.IERS_2003.getNutationCorrectionConverter();
        SortedSet<EOPEntry> data = new TreeSet<EOPEntry>(new ChronologicalComparator());
        new RapidDataAndPredictionColumnsLoader(true, "^finals2000A\\.daily$", manager).fillHistory(converter, data);
    ...
    public void testEndDateDaily2000() {
        ...
        IERSConventions.NutationCorrectionConverter converter =
                IERSConventions.IERS_2003.getNutationCorrectionConverter();
        SortedSet<EOPEntry> history = new TreeSet<EOPEntry>(new ChronologicalComparator());
        new RapidDataAndPredictionColumnsLoader(true, "^finals2000A\\.daily$", manager).fillHistory(converter, history);
        Assert.assertEquals(new AbsoluteDate(2011, 10, 6, TimeScalesFactory.getUTC()),
    ...
    public void testNoColumns() {
        ...
        SortedSet<EOPEntry> history = new TreeSet<EOPEntry>(new ChronologicalComparator());
        new RapidDataAndPredictionColumnsLoader(true, "^finals2000A-no-columns\\.daily$", manager).fillHistory(converter, history);
    ...
    public void testPost2070() {
        ...
        IERSConventions.NutationCorrectionConverter converter =
                        IERSConventions.IERS_2010.getNutationCorrectionConverter();
        SortedSet<EOPEntry> history = new TreeSet<EOPEntry>(new ChronologicalComparator());
        new RapidDataAndPredictionColumnsLoader(true, "^finals2000A-post-2070\\.daily$", manager).fillHistory(converter, history);
    ...
    private void doTestWrongFile(String fileName, int lineNumber) {
        ...
        SortedSet<EOPEntry> history = new TreeSet<EOPEntry>(new ChronologicalComparator());
        try {
            new RapidDataAndPredictionColumnsLoader(true, fileName, manager).fillHistory(converter, history);
