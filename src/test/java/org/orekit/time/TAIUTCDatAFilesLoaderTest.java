...
public class TAIUTCDatAFilesLoaderTest {
    ...
    public void testModifiedLinearData() {
        ...
        // linear models between 1961 and 1972
        checkOffset(1961,  1,  2,  -(1.4000000 +   1 * 0.000864));  // MJD 37300 +   1
        checkOffset(1961,  8,  2,  -(1.5000000 + 213 * 0.001296));  // MJD 37300 + 213
        checkOffset(1962,  1,  2,  -(1.6000000 +   1 * 0.001728));  // MJD 37665 +   1
        checkOffset(1963, 11,  2,  -(1.7000000 + 670 * 0.002160));  // MJD 37665 + 670
        checkOffset(1964,  1,  2,  -(1.8000000 - 365 * 0.002592));  // MJD 38761 - 365
        checkOffset(1964,  4,  2,  -(1.9000000 - 274 * 0.003024));  // MJD 38761 - 274
        checkOffset(1964,  9,  2,  -(2.0000000 - 121 * 0.003456));  // MJD 38761 - 121
        checkOffset(1965,  1,  2,  -(2.1000000 +   1 * 0.003888));  // MJD 38761 +   1
        checkOffset(1965,  3,  2,  -(2.2000000 +  60 * 0.004320));  // MJD 38761 +  60
        checkOffset(1965,  7,  2,  -(2.3000000 + 182 * 0.004752));  // MJD 38761 + 182
        checkOffset(1965,  9,  2,  -(2.4000000 + 244 * 0.005184));  // MJD 38761 + 244
        checkOffset(1966,  1,  2,  -(2.5000000 +   1 * 0.005616));  // MJD 39126 +   1
        checkOffset(1968,  2,  2,  -(2.6000000 + 762 * 0.006048));  // MJD 39126 + 762

        // last linear drift is not stopped as we miss the first constant offset in 1972
        checkOffset(1972,  3,  5,  -(2.6000000 +  2255 * 0.006048));  // MJD 39126 +  2255
        checkOffset(1972,  7, 14,  -(2.6000000 +  2386 * 0.006048));  // MJD 39126 +  2386
        checkOffset(1979, 12, 31,  -(2.6000000 +  5112 * 0.006048));  // MJD 39126 +  5112
        checkOffset(1980,  1, 22,  -(2.6000000 +  5134 * 0.006048));  // MJD 39126 +  5134
        checkOffset(2006,  7,  7,  -(2.6000000 + 14797 * 0.006048));  // MJD 39126 + 14797
        checkOffset(2010,  7,  7,  -(2.6000000 + 16258 * 0.006048));  // MJD 39126 + 16258
        checkOffset(2012,  7,  7,  -(2.6000000 + 16989 * 0.006048));  // MJD 39126 + 16989
        checkOffset(2015,  7,  7,  -(2.6000000 + 18084 * 0.006048));  // MJD 39126 + 18084
