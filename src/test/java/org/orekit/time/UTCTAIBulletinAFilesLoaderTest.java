...
public class UTCTAIBulletinAFilesLoaderTest {
    ...
    public void test2006Leap() throws OrekitException {
        ...
        TimeScalesFactory.addUTCTAILoader(new UTCTAIBulletinAFilesLoader("bulletina-xix-001\\.txt$"));
    ...
    public void testNoLeap() throws OrekitException {
        ...
        TimeScalesFactory.addUTCTAILoader(new UTCTAIBulletinAFilesLoader("bulletina-xxvi.*\\.txt$"));
    ...
    private void checkException(String name, OrekitMessages message) {
        Utils.setDataRoot("bulletinA");
        TimeScalesFactory.addUTCTAILoader(new UTCTAIBulletinAFilesLoader(name));
        try {
