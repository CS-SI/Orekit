...
class GMSTScaleTest {
    ...
    @Test
    void testReference() {
        assertEquals("GMST", gmst.toString());
        ...
        assertEquals(2001,  gmstComponents.getDate().getYear());
        assertEquals( 10,   gmstComponents.getDate().getMonth());
        assertEquals(  3,   gmstComponents.getDate().getDay());
        assertEquals(  7,   gmstComponents.getTime().getHour());
        assertEquals( 18,   gmstComponents.getTime().getMinute());
        assertEquals(8.329, gmstComponents.getTime().getSecond(), 4.0e-4);
    }
