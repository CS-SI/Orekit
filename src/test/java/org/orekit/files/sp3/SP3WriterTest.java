...
public class SP3WriterTest {
    ...
    private void checkEquals(final SP3 original, final SP3 rebuilt) {
    ...
    private void checkEquals(final SP3Header original, final SP3Header rebuilt) {
    ...
    private void checkEquals(final SP3Ephemeris original, final SP3Ephemeris rebuilt) {
    ...
    private void checkEquals(final SP3Segment original, final SP3Segment rebuilt) {
        Assertions.assertEquals(original.getMu(),                   rebuilt.getMu(), 0.001);
        Assertions.assertEquals(original.getStart(),                rebuilt.getStart());
        Assertions.assertEquals(original.getStop(),                 rebuilt.getStop());
        Assertions.assertEquals(original.getFrame().getName(),      rebuilt.getFrame().getName());
    ...
    private void checkEquals(final SP3Coordinate original, final SP3Coordinate rebuilt) {
