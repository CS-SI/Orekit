...
public class NavigationFileParserTest {
    ...
    public void testGpsRinex400() throws IOException {
        ...
        Assertions.assertEquals(0.0, list.get(0).getToc().durationFrom(new AbsoluteDate(2022, 10, 5, 1, 30, 0, TimeScalesFactory.getGPS())), Double.MIN_VALUE);
        ...
        Assertions.assertEquals(2230, list.get(0).getGnssDate().getWeekNumber());
    ...
    public void testBeidouRinex400() throws IOException {
        ...
        Assertions.assertEquals(0.0, list.get(0).getToc().durationFrom(new AbsoluteDate(2022, 10, 5, 0, 0, 0, TimeScalesFactory.getBDT())), Double.MIN_VALUE);
        ...
        Assertions.assertEquals(-8.439895553698e-01, list.get(0).getOrbit().getMeanAnomaly(),         1.0e-15);
        Assertions.assertEquals(-6.432645022869e-06, list.get(0).getCuc(),        1.0e-15);
        Assertions.assertEquals(5.305649829097e-04,  list.get(0).getOrbit().getE(),          1.0e-15);
        Assertions.assertEquals(8.089467883110e-06,  list.get(0).getCus(),        1.0e-15);
        Assertions.assertEquals(5.282638737345e+03,  FastMath.sqrt(list.get(0).getOrbit().getA()),      1.0e-15);
        Assertions.assertEquals(2.592000000000e+05,  list.get(0).getGnssDate().getSecondsInWeek(),       1.0e-15);
        Assertions.assertEquals(-4.377216100693e-08, list.get(0).getCic(),        1.0e-15);
        Assertions.assertEquals(1.698788226948e+00,  list.get(0).getOrbit().getRightAscensionOfAscendingNode(),     1.0e-15);
        Assertions.assertEquals(-1.303851604462e-08, list.get(0).getCis(),        1.0e-15);
        Assertions.assertEquals(9.703601465722e-01,  list.get(0).getOrbit().getI(),         1.0e-15);
        Assertions.assertEquals(2.000742187500e+02,  list.get(0).getCrc(),        1.0e-15);
        Assertions.assertEquals(-1.021547253715e+00, list.get(0).getOrbit().getPerigeeArgument(),         1.0e-15);
    ...
    public void testQZSSRinex302() throws IOException {
        ...
        final QZSSLegacyNavigationMessage qzss = file.getQZSSLegacyNavigationMessages("J07").get(0);
    ...
    public void testQZSSRinex400() throws IOException {
        ...
        Assertions.assertEquals(0.0, list.get(0).getToc().durationFrom(new AbsoluteDate(2022, 10, 5, 0, 0, 0, TimeScalesFactory.getGPS())), Double.MIN_VALUE);
    ...
    public void testQZSSRinex304() throws IOException {
        ...
        final QZSSLegacyNavigationMessage qzss = file.getQZSSLegacyNavigationMessages("J03").get(0);
    ...
    public void testGPSRinex2() throws IOException {
        ...
        Assertions.assertEquals(0.0206718930276, list02.get(0).getOrbit().getE());
        Assertions.assertEquals(-1.37437210544,  list02.get(0).getOrbit().getRightAscensionOfAscendingNode());
