...
public class NavigationFileParserTest {
    ...
    public void testGpsRinex301() throws IOException {
        ...
        final KlobucharIonosphericCorrection klobuchar = (KlobucharIonosphericCorrection) file.getHeader().getIonosphericCorrections().get(0);
    ...
    public void testGalileoRinex302() throws IOException {
        ...
        Assertions.assertEquals("LCL",                         file.getHeader().getCreationTimeZone());
        Assertions.assertEquals(1,                             file.getHeader().getIonosphericCorrections().size());
        NeQuickGIonosphericCorrection nequick = (NeQuickGIonosphericCorrection) file.getHeader().getIonosphericCorrections().get(0);
    ...
    public void testQZSSRinex302() throws IOException {
        ...
        final TimeSystemCorrection tsc = file.getHeader().getTimeSystemCorrections().get(0);
    ...
    public void testGLONASSRinex303() throws IOException {
        ...
        final GLONASSFdmaNavigationMessage glo = file.getGlonassNavigationMessages("R02").get(0);
    ...
    public void testNavICRinex303() throws IOException {
        ...
        final NavICLegacyNavigationMessage navic = file.getNavICLegacyNavigationMessages("I05").get(0);
        ...
        Assertions.assertEquals(-2.259193667639e+00, navic.getM0(), 1.0e-15);
        Assertions.assertEquals(1.492351293564e-05,  navic.getCuc(), 1.0e-15);
        Assertions.assertEquals(2.073186333291e-03,  navic.getE(), 1.0e-15);
        Assertions.assertEquals(-2.183392643929e-05, navic.getCus(), 1.0e-15);
        Assertions.assertEquals(6.493289260864e+03,  FastMath.sqrt(navic.getSma()), 1.0e-15);
        Assertions.assertEquals(0.000000000000e+00,  navic.getTime(), 1.0e-15);
        Assertions.assertEquals(-2.868473529816e-07, navic.getCic(), 1.0e-15);
        Assertions.assertEquals(1.135843714918e+00,  navic.getOmega0(), 1.0e-15);
        Assertions.assertEquals(-5.215406417847e-08, navic.getCis(), 1.0e-15);
        Assertions.assertEquals(5.007869522210e-01,  navic.getI0(), 1.0e-15);
        Assertions.assertEquals(7.530000000000e+02,  navic.getCrc(), 1.0e-15);
        Assertions.assertEquals(3.073412769875e+00,  navic.getPa(), 1.0e-15);
        ...
        Assertions.assertEquals(2077,                navic.getWeek());
        ...
        // check weeks reference in Rinex navigation are aligned with GPS weeks
        final AbsoluteDate obsRebuiltDate = new GNSSDate(navic.getWeek(), navic.getTime(), SatelliteSystem.GPS).
                                            getDate();
    ...
    public void testNavICRinex400() throws IOException {
        ...
        final NavICLegacyNavigationMessage navICL = file.getNavICLegacyNavigationMessages().get("I02").get(0);
    ...
    public void testNavICRinex402() throws IOException {
        ...
        Assertions.assertEquals( 2.300305834983e+00, navICL1.getM0(),         1.0e-12);
        Assertions.assertEquals(-8.691102266312e-06, navICL1.getCuc(),        1.0e-18);
        Assertions.assertEquals( 4.531537415460e-04, navICL1.getE(),          1.0e-16);
        Assertions.assertEquals(-3.855675458908e-06, navICL1.getCus(),        1.0e-18);
        Assertions.assertEquals( 6.493495117188e+03, navICL1.getSqrtA(),      1.0e-15);
        Assertions.assertEquals( 7.000000000000e+00, navICL1.getTime(),       1.0e-15);
        Assertions.assertEquals( 1.341104507446e-07, navICL1.getCic(),        1.0e-19);
        Assertions.assertEquals( 1.359342162629e-01, navICL1.getOmega0(),     1.0e-13);
        Assertions.assertEquals(-7.078051567078e-08, navICL1.getCis(),        1.0e-20);
        Assertions.assertEquals( 8.594830530333e-02, navICL1.getI0(),         1.0e-14);
        Assertions.assertEquals( 1.214375000000e+02, navICL1.getCrc(),        1.0e-10);
        Assertions.assertEquals(-5.136403830694e-02, navICL1.getPa(),         1.0e-14);
    ...
    public void testMixedRinex304() throws IOException {
        ...
        final GLONASSFdmaNavigationMessage glo = file.getGlonassNavigationMessages("R05").get(0);
    ...
    public void testMixedRinex305() throws IOException {
        ...
        Assertions.assertEquals(-0.1966E+06,             klobuchar.getKlobucharBeta()[2],  Double.MIN_VALUE);
        Assertions.assertEquals(-0.6554E+05,             klobuchar.getKlobucharBeta()[3],  Double.MIN_VALUE);
        final TimeSystemCorrection tsc0 = file.getHeader().getTimeSystemCorrections().get(0);
        ...
        final GLONASSFdmaNavigationMessage glo = file.getGlonassNavigationMessages("R01").get(0);
    ...
    public void testGpsRinex304() throws IOException {
        ...
        Assertions.assertEquals(0.0,                           file.getHeader().getCreationDate().durationFrom(new AbsoluteDate(2021, 3, 7, 0, 8, 19.0,
                                ...
                                0.0);
        Assertions.assertEquals(1, file.getHeader().getIonosphericCorrections().size());
        KlobucharIonosphericCorrection klobuchar = (KlobucharIonosphericCorrection) file.getHeader().getIonosphericCorrections().get(0);
        Assertions.assertEquals(IonosphericCorrectionType.GPS, klobuchar.getType());
    ...
    public void testNavICRinex304() throws IOException {
        ...
        Assertions.assertEquals(-7.075087446362e-02, navic.getM0(), 1.0e-15);
        Assertions.assertEquals(-1.282989978790e-05, navic.getCuc(), 1.0e-15);
        Assertions.assertEquals(1.970665412955e-03,  navic.getE(), 1.0e-15);
        Assertions.assertEquals(1.581013202667e-05,  navic.getCus(), 1.0e-15);
        Assertions.assertEquals(6.493357162476e+03,  FastMath.sqrt(navic.getSma()), 1.0e-15);
        Assertions.assertEquals(0.000000000000e+00,  navic.getTime(), 1.0e-15);
        Assertions.assertEquals(-7.078051567078e-08, navic.getCic(), 1.0e-15);
        Assertions.assertEquals(-1.270986014126e+00, navic.getOmega0(), 1.0e-15);
        Assertions.assertEquals(2.160668373108e-07,  navic.getCis(), 1.0e-15);
        Assertions.assertEquals(5.051932936599e-01,  navic.getI0(), 1.0e-15);
        Assertions.assertEquals(-4.082500000000e+02, navic.getCrc(), 1.0e-15);
        Assertions.assertEquals(-2.990028662993e+00, navic.getPa(), 1.0e-15);
        ...
        Assertions.assertEquals(2148,                navic.getWeek());
    ...
    public void testStoRinex400() throws IOException {
        ...
        Assertions.assertEquals(PredefinedTimeSystem.BEIDOU, list.get(0).getDefinedTimeSystem());
        Assertions.assertEquals(PredefinedTimeSystem.GALILEO, list.get(0).getReferenceTimeSystem());
