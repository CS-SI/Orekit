...
public class AEMParserTest {
    ...
    public void testParseAEM01() {
        ...
        final Segment<AemMetadata, AemData> segment0 = file.getSegments().getFirst();
        ...
        verifyAngularCoordinates(new TimeStampedAngularCoordinates(new AbsoluteDate(1996, 11, 28, 21, 29,
                                                                   ...
                                                                   Vector3D.ZERO,
                                                                   Vector3D.ZERO),
                                 segment0.getData().getAngularCoordinates().getFirst(), 1.0e-5);
        ...
        verifyAngularCoordinates(new TimeStampedAngularCoordinates(new AbsoluteDate(1996, 12, 18, 12, 5, new TimeOffset(555500, TimeOffset.MICROSECOND),
                                                                   ...
                                                                   Vector3D.ZERO,
                                                                   Vector3D.ZERO),
                                 segment1.getData().getAngularCoordinates().getFirst(), 1.0e-5);
    ...
    public void testParseAEM02() {
        ...
        Assertions.assertEquals(0.0, parser.getMissionReferenceDate().durationFrom(new AbsoluteDate(1996, 12, 17, 0, 0, 0.0,
                                                                                                    TimeScalesFactory.getUTC())), 1.0e-5);
    ...
    private void validateAEM03(final Aem file) {
        ...
        Assertions.assertEquals("Spin KF ground solution, SPINKF rates", segment0.getData().getComments().getFirst());
    ...
    public void testParseAEM06a() {
        ...
        final Aem file = parser.parseMessage(source);
        final TimeStampedAngularCoordinates ac = file.getSegments().getFirst().getAngularCoordinates().get(7);
    ...
    public void testParseAEM07() {
        ...
        final TimeStampedAngularCoordinates ac0 = segment0.getData().getAngularCoordinates().getFirst();
    ...
    public void testDefaultInterpolationDegree() {
        ...
        Assertions.assertEquals(7, file2.getSegments().getFirst().getMetadata().getInterpolationDegree());
