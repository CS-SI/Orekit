...
public class TdmParserTest {
    ...
    private void validateTDMExample2(Tdm file) {
        ...
        Assertions.assertEquals(0.0, new AbsoluteDate("2005-160T20:15:00", utc).durationFrom(file.getHeader().getCreationDate()), 0.0);
        ...
        Assertions.assertEquals(0.0, new AbsoluteDate("2005-159T17:41:00", utc).durationFrom(metadata.getStartTime().orElseThrow()), 0.0);
        Assertions.assertEquals(0.0, new AbsoluteDate("2005-159T17:41:40", utc).durationFrom(metadata.getStopTime().orElseThrow()), 0.0);
        ...
        Assertions.assertEquals(TrackingMode.SEQUENTIAL, metadata.getMode().orElseThrow());
        Assertions.assertArrayEquals(new int[] { 2, 1 }, metadata.getPath().orElseThrow());
        Assertions.assertEquals(1.0, metadata.getIntegrationInterval().orElseThrow(), 0.0);
        Assertions.assertEquals(IntegrationReference.MIDDLE, metadata.getIntegrationRef().orElseThrow());
        Assertions.assertEquals(32021035200.0, metadata.getFreqOffset().orElseThrow(), 0.0);
        ...
        Assertions.assertEquals(DataQuality.RAW, metadata.getDataQuality().orElseThrow());
        ...
        for (int i = 0; i < keywords.length; i++) {
            ...
            Assertions.assertEquals(0.0, new AbsoluteDate(epochs[i], utc).durationFrom(observations.get(i).getEpoch()), 0.0);
        ...
        Assertions.assertEquals(1.25, metadata.getTransmitDelays().get(12), 1.0e-15);
        metadata.setReceiveDelays(Collections.singletonMap(12, 2.5));
        Assertions.assertNull(metadata.getReceiveDelays().get(1));
        Assertions.assertEquals(2.5, metadata.getReceiveDelays().get(12), 1.0e-15);
    ...
    private void validateTDMExample4(Tdm file) {
        ...
        // Header
        Assertions.assertEquals(1.0, file.getHeader().getFormatVersion(), 0.0);
        Assertions.assertEquals(0.0, new AbsoluteDate("2005-191T23:00:00", utc).durationFrom(file.getHeader().getCreationDate()), 0.0);
        Assertions.assertEquals("NASA/JPL",file.getHeader().getOriginator());
        final List<String> headerComment = new ArrayList<>();
        headerComment.add("TDM example created by yyyyy-nnnA Nav Team (NASA/JPL)");
        Assertions.assertEquals(headerComment, file.getHeader().getComments());
        ...
        Assertions.assertEquals("yyyy-nnnA", metadata.getParticipants().get(2));
        Assertions.assertEquals(TrackingMode.SEQUENTIAL, metadata.getMode().orElseThrow());
        Assertions.assertArrayEquals(new int[] { 1, 2, 1 }, metadata.getPath().orElseThrow());
        Assertions.assertEquals(IntegrationReference.START, metadata.getIntegrationRef().orElseThrow());
        Assertions.assertEquals(RangeMode.COHERENT, metadata.getRangeMode().orElseThrow());
        Assertions.assertEquals(2.0e+26, metadata.getRawRangeModulus().orElseThrow(), 0.0);
        Assertions.assertEquals(2.0e+26, metadata.getRangeModulus(new IdentityConverter()).orElseThrow(), 0.0);
        Assertions.assertEquals(RangeUnits.RU, metadata.getRangeUnits().orElseThrow());
        ...
        Assertions.assertEquals(46.7741, metadata.getCorrectionRange(new IdentityConverter()).orElseThrow(), 0.0);
        Assertions.assertEquals(46.7741, metadata.getRawCorrectionRange().orElseThrow(), 0.0);
        Assertions.assertEquals(CorrectionApplied.YES, metadata.getCorrectionsApplied().orElseThrow());
        final List<String> metaDataComment = new ArrayList<>();
    ...
    private void validateTDMExample6(Tdm file) {
        ...
        // Header
        Assertions.assertEquals(1.0, file.getHeader().getFormatVersion(), 0.0);
        Assertions.assertEquals(0.0, new AbsoluteDate("1998-06-10T01:00:00", utc).durationFrom(file.getHeader().getCreationDate()), 0.0);
        ...
        Assertions.assertEquals("UTC", metadata.getTimeSystem().name());
        Assertions.assertEquals(0.0, new AbsoluteDate("1998-06-10T00:57:37", utc).durationFrom(metadata.getStartTime().orElseThrow()), 0.0);
        Assertions.assertEquals(0.0, new AbsoluteDate("1998-06-10T00:57:44", utc).durationFrom(metadata.getStopTime().orElseThrow()), 0.0);
        ...
        Assertions.assertEquals(TrackingMode.SEQUENTIAL, metadata.getMode().orElseThrow());
        Assertions.assertArrayEquals(new int[] { 1, 2, 3, 2, 1 }, metadata.getPath().orElseThrow());
        Assertions.assertEquals(1.0, metadata.getIntegrationInterval().orElseThrow(), 0.0);
        Assertions.assertEquals(IntegrationReference.MIDDLE, metadata.getIntegrationRef().orElseThrow());
        Assertions.assertEquals(RangeMode.CONSTANT, metadata.getRangeMode().orElseThrow());
        Assertions.assertEquals(1.0, metadata.getRawRangeModulus().orElseThrow(), 0.0);
        Assertions.assertEquals(1000.0, metadata.getRangeModulus(new IdentityConverter()).orElseThrow(), 0.0);
        Assertions.assertEquals(RangeUnits.km, metadata.getRangeUnits().orElseThrow());
        Assertions.assertEquals(AngleType.AZEL, metadata.getAngleType().orElseThrow());
        Assertions.assertEquals(2.0, metadata.getRawCorrectionRange().orElseThrow(), 0.0);
        Assertions.assertEquals(2000.0, metadata.getCorrectionRange(new IdentityConverter()).orElseThrow(), 0.0);
        Assertions.assertEquals(CorrectionApplied.YES, metadata.getCorrectionsApplied().orElseThrow());
    ...
    private void validateTDMExample8(Tdm file) {
        ...
        // Header
        Assertions.assertEquals(1.0, file.getHeader().getFormatVersion(), 0.0);
        Assertions.assertEquals(0.0, new AbsoluteDate("2007-08-30T12:01:44.749", utc).durationFrom(file.getHeader().getCreationDate()), 0.0);
        ...
        Assertions.assertEquals("UTC", metadata.getTimeSystem().name());
        Assertions.assertEquals(0.0, new AbsoluteDate("2007-08-29T07:00:02.000", utc).durationFrom(metadata.getStartTime().orElseThrow()), 0.0);
        Assertions.assertEquals(0.0, new AbsoluteDate("2007-08-29T14:00:02.000", utc).durationFrom(metadata.getStopTime().orElseThrow()), 0.0);
        Assertions.assertEquals("HBSTK", metadata.getParticipants().get(1));
        Assertions.assertEquals("SAT", metadata.getParticipants().get(2));
        Assertions.assertEquals(TrackingMode.SEQUENTIAL, metadata.getMode().orElseThrow());
        Assertions.assertArrayEquals(new int[] { 1, 2, 1 }, metadata.getPath().orElseThrow());
        Assertions.assertEquals(1.0, metadata.getIntegrationInterval().orElseThrow(), 0.0);
        Assertions.assertEquals(IntegrationReference.END, metadata.getIntegrationRef().orElseThrow());
        Assertions.assertEquals(AngleType.XSYE, metadata.getAngleType().orElseThrow());
        Assertions.assertEquals(DataQuality.RAW, metadata.getDataQuality().orElseThrow());
        final List<String> metaDataComment = new ArrayList<>();
        metaDataComment.add("This is a meta-data comment");
        Assertions.assertEquals(metaDataComment, metadata.getComments());
        ...
        Assertions.assertEquals("UTC", metadata.getTimeSystem().name());
        Assertions.assertEquals(0.0, new AbsoluteDate("2007-08-29T06:00:02.000", utc).durationFrom(metadata2.getStartTime().orElseThrow()), 0.0);
        Assertions.assertEquals(0.0, new AbsoluteDate("2007-08-29T13:00:02.000", utc).durationFrom(metadata2.getStopTime().orElseThrow()), 0.0);
        Assertions.assertEquals("WHM1", metadata2.getParticipants().get(1));
        Assertions.assertEquals("SAT", metadata2.getParticipants().get(2));
        Assertions.assertEquals(TrackingMode.SEQUENTIAL, metadata2.getMode().orElseThrow());
        Assertions.assertArrayEquals(new int[] { 1, 2, 1 }, metadata2.getPath().orElseThrow());
        Assertions.assertEquals(1.0, metadata2.getIntegrationInterval().orElseThrow(), 0.0);
        Assertions.assertEquals(IntegrationReference.END, metadata2.getIntegrationRef().orElseThrow());
        Assertions.assertEquals(1.0e7, metadata2.getRawRangeModulus().orElseThrow(), 0.0);
        Assertions.assertEquals(1.0e7 * Constants.SPEED_OF_LIGHT, metadata2.getRangeModulus(new IdentityConverter()).orElseThrow(), 0.0);
        Assertions.assertEquals(RangeUnits.s, metadata2.getRangeUnits().orElseThrow());
        Assertions.assertEquals(AngleType.AZEL, metadata2.getAngleType().orElseThrow());
        Assertions.assertEquals(DataQuality.RAW, metadata2.getDataQuality().orElseThrow());
        Assertions.assertEquals(2.0, metadata2.getRawCorrectionRange().orElseThrow(), 0.0);
        Assertions.assertEquals(2.0 * Constants.SPEED_OF_LIGHT, metadata2.getCorrectionRange(new IdentityConverter()).orElseThrow(), 0.0);
        Assertions.assertEquals(CorrectionApplied.YES, metadata2.getCorrectionsApplied().orElseThrow());
        final List<String> metaDataComment2 = new ArrayList<>();
        ...
        for (int i = 0; i < keywords2.length; i++) {
            ...
            Assertions.assertEquals(0.0, new AbsoluteDate(epochs2[i], utc).durationFrom(observations2.get(i).getEpoch()), 0.0);
            Assertions.assertEquals(values2[i], observations2.get(i).getMeasurement(), 1.0e-12 * FastMath.abs(values2[i]));
        }
        // Comment
        final List<String> dataComment2 = new ArrayList<>();
    ...
    private void validateTDMExample15(Tdm file) {
        ...
        // Header
        Assertions.assertEquals(1.0, file.getHeader().getFormatVersion(), 0.0);
        Assertions.assertEquals(0.0, new AbsoluteDate("2005-161T15:45:00", utc).durationFrom(file.getHeader().getCreationDate()), 0.0);
        Assertions.assertEquals("NASA/JPL",file.getHeader().getOriginator());
        final List<String> headerComment = new ArrayList<>();
        headerComment.add("TDM example created by yyyyy-nnnA Nav Team (NASA/JPL)");
        ...
        Assertions.assertEquals("UTC", metadata.getTimeSystem().name());
        Assertions.assertEquals(0.0, new AbsoluteDate("2005-142T12:00:00", utc).durationFrom(metadata.getStartTime().orElseThrow()), 0.0);
        Assertions.assertEquals(0.0, new AbsoluteDate("2005-145T12:00:00", utc).durationFrom(metadata.getStopTime().orElseThrow()), 0.0);
        ...
        Assertions.assertEquals(0.0, new AbsoluteDate("2005-142T12:00:00", utc).durationFrom(metadata2.getStartTime().orElseThrow()), 0.0);
        Assertions.assertEquals(0.0, new AbsoluteDate("2005-145T12:00:00", utc).durationFrom(metadata2.getStopTime().orElseThrow()), 0.0);
        ...
        for (int i = 0; i < keywords.length; i++) {
            ...
            Assertions.assertEquals(0.0, new AbsoluteDate(epochs[i], utc).durationFrom(observations2.get(i).getEpoch()), 0.0);
        ...
        Assertions.assertEquals(0.0, new AbsoluteDate("2005-142T12:00:00", utc).durationFrom(metadata3.getStartTime().orElseThrow()), 0.0);
        Assertions.assertEquals(0.0, new AbsoluteDate("2005-145T12:00:00", utc).durationFrom(metadata3.getStopTime().orElseThrow()), 0.0);
        ...
        final List<String> metaDataComment3 = new ArrayList<>();
        ...
        for (int i = 0; i < keywords.length; i++) {
            ...
            Assertions.assertEquals(0.0, new AbsoluteDate(epochs[i], utc).durationFrom(observations3.get(i).getEpoch()), 0.0);
            Assertions.assertEquals(values3[i], observations3.get(i).getMeasurement(), 0.0);
        }
        // Comment
        final List<String> dataComment3 = new ArrayList<>();
    ...
    private void validateTDMExampleAllKeywordsSingleDiff(Tdm file) {
        validateTDMExampleAllKeywordsCommon(file);
        final TdmMetadata metadata = file.getSegments().getFirst().getMetadata();
        Assertions.assertEquals(TrackingMode.SINGLE_DIFF, metadata.getMode().orElseThrow());
        Assertions.assertArrayEquals(new int[] { 4, 5 }, metadata.getPath1().orElseThrow());
        Assertions.assertArrayEquals(new int[] { 3, 2 }, metadata.getPath2().orElseThrow());
    }
    ...
    private void validateTDMExampleAllKeywordsCommon(Tdm file) {
        ...
        Assertions.assertEquals(0.0, new AbsoluteDate("2017-06-14T10:53:00.000", utc).durationFrom(file.getHeader().getCreationDate()), 0.0);
        Assertions.assertEquals("CS GROUP",file.getHeader().getOriginator());
        Assertions.assertEquals("04655f62-1ba0-4ca6-92e9-eb3411db3d44", file.getHeader().getMessageId().orElseThrow().toLowerCase());
        final List<String> headerComment = new ArrayList<>();
        ...
        Assertions.assertEquals("UTC", metadata.getTimeSystem().name());
        Assertions.assertEquals(0.0, new AbsoluteDate("2017-06-14T10:53:00.000", utc).durationFrom(metadata.getStartTime().orElseThrow()), 0.0);
        Assertions.assertEquals(0.0, new AbsoluteDate("2017-06-15T10:53:00.000", utc).durationFrom(metadata.getStopTime().orElseThrow()), 0.0);
        Assertions.assertEquals("DSS-25", metadata.getParticipants().get(1));
        Assertions.assertEquals("yyyy-nnnA", metadata.getParticipants().get(2));
        ...
        Assertions.assertEquals("S", metadata.getTransmitBand().orElseThrow());
        Assertions.assertEquals("L", metadata.getReceiveBand().orElseThrow());
        Assertions.assertEquals(240, metadata.getTurnaroundNumerator().orElseThrow(), 0);
        Assertions.assertEquals(221, metadata.getTurnaroundDenominator().orElseThrow(), 0);
        Assertions.assertEquals(TimetagReference.TRANSMIT, metadata.getTimetagRef().orElseThrow());
        Assertions.assertEquals(1.0, metadata.getIntegrationInterval().orElseThrow(), 0.0);
        Assertions.assertEquals(IntegrationReference.MIDDLE, metadata.getIntegrationRef().orElseThrow());
        Assertions.assertEquals(32021035200.0, metadata.getFreqOffset().orElseThrow(), 0.0);
        Assertions.assertEquals(RangeMode.COHERENT, metadata.getRangeMode().orElseThrow());
        Assertions.assertEquals(32768.0, metadata.getRawRangeModulus().orElseThrow(), 0.0);
        Assertions.assertEquals(RangeUnits.RU, metadata.getRangeUnits().orElseThrow());
        Assertions.assertEquals(AngleType.RADEC, metadata.getAngleType().orElseThrow());
        Assertions.assertEquals("EME2000", metadata.getReferenceFrame().orElseThrow().getName());
        Assertions.assertEquals(CelestialBodyFrame.EME2000, metadata.getReferenceFrame().get().asCelestialBodyFrame().orElseThrow());
        Assertions.assertEquals(FramesFactory.getEME2000(), metadata.getReferenceFrame().get().asFrame().orElseThrow());
        Assertions.assertEquals("HERMITE", metadata.getInterpolationMethod().orElseThrow());
        Assertions.assertEquals(5, metadata.getInterpolationDegree().orElseThrow());
        Assertions.assertEquals(120000.0, metadata.getDopplerCountBias().orElseThrow(), 1.0e-5);
        Assertions.assertEquals(1000.0, metadata.getDopplerCountScale().orElseThrow(), 1.0e-10);
        Assertions.assertFalse(metadata.hasDopplerCountRollover().orElseThrow());
        Assertions.assertEquals(0.000077, metadata.getTransmitDelays().get(1), 0.0);
        ...
        Assertions.assertEquals(DataQuality.RAW, metadata.getDataQuality().orElseThrow());
        Assertions.assertEquals(FastMath.toRadians(1.0), metadata.getCorrectionAngle1().orElseThrow(), 0.0);
        Assertions.assertEquals(FastMath.toRadians(2.0), metadata.getCorrectionAngle2().orElseThrow(), 0.0);
        Assertions.assertEquals(3000.0, metadata.getCorrectionDoppler().orElseThrow(), 0.0);
        Assertions.assertEquals(4.0, metadata.getCorrectionMagnitude().orElseThrow(), 0.0);
        Assertions.assertEquals(5.0, metadata.getRawCorrectionRange().orElseThrow(), 0.0);
        Assertions.assertEquals(6.0, metadata.getCorrectionRcs().orElseThrow(), 0.0);
        Assertions.assertEquals(7.0, metadata.getCorrectionReceive().orElseThrow(), 0.0);
        Assertions.assertEquals(8.0, metadata.getCorrectionTransmit().orElseThrow(), 0.0);
        Assertions.assertEquals(FastMath.toRadians(9.0), metadata.getCorrectionAberrationYearly().orElseThrow(), 0.0);
        Assertions.assertEquals(FastMath.toRadians(10.0), metadata.getCorrectionAberrationDiurnal().orElseThrow(), 0.0);
        Assertions.assertEquals(CorrectionApplied.YES, metadata.getCorrectionsApplied().orElseThrow());
    ...
    public void testFrameMapper() {
        ...
        MatcherAssert.assertThat(
                tdm.getSegments().getFirst().getMetadata().getRadecFrame().orElseThrow(),
