...
public class StreamingOcmWriterTest {
    ...
    private static void partialCompareOcmEphemerisBlocks(TrajectoryStateHistory block1, TrajectoryStateHistory block2) {
        ...
        for (int i = 0; i < block1.getTrajectoryStates().size(); i++) {
            ...
            TimeStampedPVCoordinates pv1 = c1.getType().toCartesian(c1.getDate(), c1.getElements(), block1.getMu());
            TimeStampedPVCoordinates pv2 = c2.getType().toCartesian(c2.getDate(), c2.getElements(), block2.getMu());
    ...
    private static void partialCompareOcmEphemerisBlocksMetadata(TrajectoryStateHistoryMetadata meta1, TrajectoryStateHistoryMetadata meta2) {
    ...
    static void partialCompareOcms(Ocm file1, Ocm file2) {
