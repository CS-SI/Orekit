...
class KvnGeneratorTest {
    ...
    void testSection() throws IOException {
        ...
        try (Generator generator = new KvnGenerator(caw, 10, "", Constants.JULIAN_DAY, 25)) {
            ...
            assertEquals("CCSDS_ABC_VERSION = 99.0\n" +
                                "BLOCK_START\n" +
                                "KEY        = 1234567.8   [Hz]\n" +
                                "BLOCK_STOP\n",
                                caw.toString());
    ...
    @Test
    void testCcsdsUnits() throws IOException {
        CharArrayWriter caw = new CharArrayWriter();
        try (Generator generator = new KvnGenerator(caw, 10, "", Constants.JULIAN_DAY, 25)) {
            ...
            assertEquals("KEY_1      = 1234.5678   [km*kg**3/s**0.5]\n" +
                                "KEY_2      = 1234567.8\n" +
                                "KEY_3      = 1234567.8\n" +
                                "LOOOOONG   = 1234567.8\n",
                                caw.toString());
    ...
    @Test
    void testUnitsPadding() throws IOException {
        CharArrayWriter caw = new CharArrayWriter();
    ...
    @Test
    void testNoUnits() throws IOException {
        CharArrayWriter caw = new CharArrayWriter();
