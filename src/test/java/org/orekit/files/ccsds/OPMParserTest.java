...
public class OPMParserTest {
    ...
    public void testParseOPM1()
        ...
        // Check Header Block;
        Assert.assertEquals("2.0", file.getFormatVersion());
        ...
        Assert.assertEquals("GODZILLA 5", file.getObjectName());
        Assert.assertEquals("1998-057A", file.getObjectID());
        Assert.assertEquals("EARTH", file.getCenterName());
        Assert.assertTrue(file.getHasCreatableBody());
        Assert.assertEquals(CelestialBodyFactory.getEarth(), file.getCenterBody());
        Assert.assertEquals(FramesFactory.getITRF97(), file.getFrame());
        Assert.assertEquals(TimeSystem.TAI, file.getTimeSystem());
        Assert.assertEquals(TimeScalesFactory.getTAI(), file.getTimeScale());        
        ...
        try {
            ...
            Assert.assertEquals(OrekitMessages.NON_PSEUDO_INERTIAL_FRAME_NOT_SUITABLE_FOR_DEFINING_ORBITS,
        ...
        try {
            ...
            Assert.assertEquals(OrekitMessages.CCSDS_UNKNOWN_SPACECRAFT_MASS,
                                orekitException.getSpecifier());
        }
    ...
    public void testParseOPM2()
        ...
        Assert.assertEquals(file.getComment(ODMBlock.HEADER), headerComment);
        ...
        Assert.assertEquals("EUTELSAT W4", file.getObjectName());
        Assert.assertEquals("2000-028A", file.getObjectID());
        Assert.assertEquals("EARTH", file.getCenterName());
        Assert.assertTrue(file.getHasCreatableBody());
        Assert.assertEquals(CelestialBodyFactory.getEarth(), file.getCenterBody());
        Assert.assertEquals(FramesFactory.getGCRF(), file.getFrame());
        Assert.assertEquals(TimeSystem.GPS, file.getTimeSystem());
        Assert.assertEquals(TimeScalesFactory.getGPS(), file.getTimeScale());

        // Check Data State Vector block
        ArrayList<String> StateVectorComment = new ArrayList<String>();
        StateVectorComment.add("State Vector");
        Assert.assertEquals(file.getComment(ODMBlock.DATA_STATE_VECTOR),
                            StateVectorComment);
        ...
        Assert.assertTrue(file.getHasKeplerianElements());
        ArrayList<String> StateKeplerianElementsComment = new ArrayList<String>();
        StateKeplerianElementsComment.add("Keplerian elements");
        Assert.assertEquals(StateKeplerianElementsComment,
                            file.getComment(ODMBlock.DATA_KEPLERIAN_ELEMENTS));
        ...
        ArrayList<String> StateSpacecraftComment = new ArrayList<String>();
        StateSpacecraftComment.add("Spacecraft parameters");
        Assert.assertEquals(StateSpacecraftComment, file.getComment(ODMBlock.DATA_SPACECRAFT));        
    ...
    public void testParseOPM3()
        ...
        Assert.assertEquals(new AbsoluteDate(1998, 12, 18, 14, 28, 15.1172,
                                                 TimeScalesFactory.getGMST()), file.getFrameEpoch());
        ...
        Assert.assertEquals(file.getComment(ODMBlock.DATA_COVARIANCE),
                            dataCovMatrixComment);
