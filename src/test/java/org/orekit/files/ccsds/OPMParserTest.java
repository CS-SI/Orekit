...
public class OPMParserTest {
    ...
    public void testParseOPM1()
        ...
        // data.
        final String ex = "/ccsds/OPMExample1.txt";
    ...
    public void testParseOPM5()
        ...
        final String ex = "/ccsds/OPMExample5.txt";
    ...
    public void testParseOPM3()
        ...
        Assert.assertNull(file.getCovRefFrame());
    ...
    public void testParseOPM6()
        ...
        // simple test for OPM file, contains all mandatory information plus
        // Spacecraft parameters and the position/velocity Covariance Matrix.
        final String name = getClass().getResource("/ccsds/OPMExample6.txt").toURI().getPath();
        OPMParser parser = new OPMParser().withConventions(IERSConventions.IERS_2010);
        final OPMFile file = parser.parse(name);
        Assert.assertEquals(new AbsoluteDate(1998, 12, 18, 14, 28, 15.1172,
                                             TimeScalesFactory.getGMST(IERSConventions.IERS_2010, false)),
        ...
        Assert.assertEquals(1, file.getMetaDataComment().size());
        Assert.assertEquals("GEOCENTRIC, CARTESIAN, EARTH FIXED", file.getMetaDataComment().get(0));
        Assert.assertEquals("OREKIT-4D00FC96-AC64-11E9-BF71-001FD054093C", file.getMetaData().getMessageID());
        Assert.assertEquals("UNCLASSIFIED", file.getMetaData().getMessageClassification());
    ...
    public void testWrongODMType() {
        try {
            new OPMParser().parse(getClass().getResourceAsStream("/ccsds/OMMExample1.txt"), "OMMExample1.txt");
        } catch (OrekitException oe) {
    ...
    public void testNonExistentFile() throws URISyntaxException {
        final String realName = getClass().getResource("/ccsds/OPMExample1.txt").toURI().getPath();
