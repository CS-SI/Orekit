...
public class GlobalPressureTemperature2wTest {
    ...
    public void testMatlabRef0() throws IOException, URISyntaxException {
        ...
        // reference output obtained by running TU-Wien https://vmf.geo.tuwien.ac.at/codes/gpt2_5w.m matlab script
        ...
        final URL url = GlobalPressureTemperature2wTest.class.getClassLoader().getResource("gpt-grid/gpt2_5w.grd");
        ...
        Assertions.assertEquals(16.716708631,          TroposphericModelUtils.HECTO_PASCAL.fromSI(pth.getWaterVaporPressure()), 1.0e-9);
        Assertions.assertEquals(281.105772206,         pth.getTm(),                 1.0e-9);
        Assertions.assertEquals(2.696356799,           pth.getLambda(),             1.0e-9);
    ...
    public void testMatlabRef1() throws IOException, URISyntaxException {
        ...
        Assertions.assertEquals(1.190041916,           TroposphericModelUtils.HECTO_PASCAL.fromSI(pth.getWaterVaporPressure()), 1.0e-9);
        Assertions.assertEquals(249.890425603,         pth.getTm(),                 1.0e-9);
        Assertions.assertEquals(1.775637732,           pth.getLambda(),             1.0e-9);
    ...
    public void testMatlabRef2() throws IOException, URISyntaxException {
        ...
        Assertions.assertEquals(0.980537646,           TroposphericModelUtils.HECTO_PASCAL.fromSI(pth.getWaterVaporPressure()), 1.0e-9);
        Assertions.assertEquals(249.160977382,         pth.getTm(),                 1.0e-9);
        Assertions.assertEquals(1.629659768,           pth.getLambda(),             1.0e-9);
    ...
    protected <T extends CalculusFieldElement<T>> void doTestFieldMatlabRef0(final Field<T> field)
        ...
        Assertions.assertEquals(16.716708631,          TroposphericModelUtils.HECTO_PASCAL.fromSI(pth.getWaterVaporPressure()).getReal(), 1.0e-9);
        Assertions.assertEquals(281.105772206,         pth.getTm().getReal(),                 1.0e-9);
        Assertions.assertEquals(2.696356799,           pth.getLambda().getReal(),             1.0e-9);
    ...
    protected <T extends CalculusFieldElement<T>> void doTestFieldMatlabRef1(final Field<T> field)
        ...
        Assertions.assertEquals(1.190041916,           TroposphericModelUtils.HECTO_PASCAL.fromSI(pth.getWaterVaporPressure()).getReal(), 1.0e-9);
        Assertions.assertEquals(249.890425603,         pth.getTm().getReal(),                 1.0e-9);
        Assertions.assertEquals(1.775637732,           pth.getLambda().getReal(),             1.0e-9);
    ...
    protected <T extends CalculusFieldElement<T>> void doTestFieldMatlabRef2(final Field<T> field)
        ...
        Assertions.assertEquals(0.980537646,           TroposphericModelUtils.HECTO_PASCAL.fromSI(pth.getWaterVaporPressure()).getReal(), 1.0e-9);
        Assertions.assertEquals(249.160977382,         pth.getTm().getReal(),                 1.0e-9);
        Assertions.assertEquals(1.629659768,           pth.getLambda().getReal(),             1.0e-9);
