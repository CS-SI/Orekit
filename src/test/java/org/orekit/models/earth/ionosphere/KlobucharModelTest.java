...
import org.orekit.frames.FieldTopocentricFrame;
...
public class KlobucharModelTest {
    ...
    public void testEquality() {
        ...
        final double delayPV = model.pathDelay(date, orbit, topo, earth, 1575.42e6, model.getParameters());
    ...
    private <T extends RealFieldElement<T>> void doTestFieldEquality(final Field<T> field) {
        ...
        // Delay using PVCoordinates
        FieldTopocentricFrame<T> fieldTopo = new FieldTopocentricFrame<T>(earth, point, "Gstation");
        T delayPV = model.pathDelay(dateF, orbit, fieldTopo, earth, 1575.42e6, model.getParameters(field));
