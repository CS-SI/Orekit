...
public class FixedTroposphericModelTest {
    ...
    public void testModel() {
        ...
        final double delay = model.calculatePathDelay(35d, 1200d);
    ...
    public void testSymmetry() {
        for (int elevation = 0; elevation < 90; elevation += 10) {
            final double delay1 = model.calculatePathDelay(elevation, 100);
            final double delay2 = model.calculatePathDelay(180 - elevation, 100);
