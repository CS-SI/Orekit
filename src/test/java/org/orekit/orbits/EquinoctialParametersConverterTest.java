...
class EquinoctialParametersConverterTest {
    ...
    void testBackAndForthElliptic(final PositionAngleType positionAngleType) {
        ...
        final EquinoctialParametersConverter converter = new EquinoctialParametersConverter(1);
        // WHEN
        final EquinoctialParameters elements = converter.toParameters(pv, positionAngleType);
