...
class HaloOrbitTest {
    ...
    void testManifolds() {
        ...
        assertNotEquals(finalState.getPosition().getZ(), initialUnstableManifold.getPosition().getZ(), 1E-7);
        ...
        assertNotEquals(finalState.getPosition().getZ(), initialStableManifold.getPosition().getZ(), 1E-7);
    }
