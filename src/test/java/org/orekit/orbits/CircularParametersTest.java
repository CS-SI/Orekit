...
class CircularParametersTest {
    ...
    private void templateTestBackAndForthElliptical(final PositionAngleType initialType,
        ...
        // GIVEN
        final CircularParameters expectedElements = new CircularParameters(1., 0.5, 0.5, 0.5, 0.5, 0.5, initialType);
        // WHEN
        final CircularParameters elements = expectedElements.withPositionAngleType(intermediateType);
        final CircularParameters actualElements = elements.withPositionAngleType(initialType);
        // THEN
        ...
        assertEquals(expectedElements.latitudeArgument(), actualElements.latitudeArgument(), 1e-12);
    }
}
