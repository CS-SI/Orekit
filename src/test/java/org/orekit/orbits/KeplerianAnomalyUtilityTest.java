...
class KeplerianAnomalyUtilityTest {
    ...
    void testEllipticMeanToTrue() {
        ...
        assertEquals(2.4004986679372027, v, 1e-14);
    }
    ...
    void testEllipticTrueToMean() {
        ...
        assertEquals(0.5238159114936672, M, 1e-14);
    }
    ...
    void testEllipticEccentricToTrue() {
        ...
        assertEquals(3.903008140176819, v, 1e-14);
    }
    ...
    void testEllipticTrueToEccentric() {
        ...
        assertEquals(0.44240462411915754, E, 1e-14);
    }
    ...
    void testEllipticEccentricToMean() {
        ...
        assertEquals(1.881803817764882, M, 1e-14);
    }
    ...
    void testHyperbolicMeanToTrue() {
        ...
        assertEquals(2.8254185280004855, v, 1e-14);
    }
    ...
    void testHyperbolicTrueToMean() {
        ...
        assertEquals(-2.5499244818919915, M, 1e-14);
    }
    ...
    void testHyperbolicEccentricToTrue() {
        ...
        assertEquals(-1.4528528149658333, v, 1e-14);
    }
    ...
    void testHyperbolicTrueToEccentric() {
        ...
        assertEquals(0.1440079208139455, E, 1e-14);
    }
    ...
    void testHyperbolicMeanToEccentric() {
        ...
        assertEquals(4.550432282228856, E8, 1e-14);
    }
    ...
    void testHyperbolicEccentricToMean() {
        ...
        assertEquals(20.77894350750361, M, 1e-14);
    }
