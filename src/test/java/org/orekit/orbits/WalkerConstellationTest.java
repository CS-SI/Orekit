...
import org.orekit.orbits.WalkerConstellation.Pattern;
...
public class WalkerConstellationTest {
    ...
    public void testContainer() {
        ...
        Assertions.assertEquals(Pattern.DELTA, w.getPattern());
    }
    @Test
    ...
    @Test
    public void testDeltaRegularPhasing() {
    ...
    @Test
    public void testDeltaInOrbitSpares() {
        final CircularOrbit reference = new CircularOrbit(29600000.0, 1.0e-3, 1.2e-4,
                                                          FastMath.toRadians(56.0), FastMath.toRadians(0),
                                                          FastMath.toRadians(0), PositionAngleType.MEAN,
                                                          FramesFactory.getEME2000(),
    ...
    @Test
    public void testStarRegularPhasing() {
        final CircularOrbit reference = new CircularOrbit(7200000.0, -5.0e-4, 1.2e-3,
                                                          FastMath.toRadians(98.7), FastMath.toRadians(0.),
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            for (int j = 0; j < 8; ++j) {
                ...
                Assertions.assertEquals(FastMath.toDegrees(reference.getI()),
                                        FastMath.toDegrees(c.getI()),
                                        1.0e-14);
                Assertions.assertEquals(i * 60.0,
                                        FastMath.toDegrees(MathUtils.normalizeAngle(c.getRightAscensionOfAscendingNode(),
                                                                                    FastMath.PI)),
                                        9.0e-14);
                Assertions.assertEquals(i * 15.0 + j * 45.0,
    ...
    @Test
    public void testStarInOrbitSpares() {
        final CircularOrbit reference = new CircularOrbit(7200000.0, -5.0e-4, 1.2e-3,
                                                          FastMath.toRadians(98.7), FastMath.toRadians(0.),
                                                          FastMath.toRadians(0.0), PositionAngleType.MEAN,
                                                          FramesFactory.getEME2000(),
