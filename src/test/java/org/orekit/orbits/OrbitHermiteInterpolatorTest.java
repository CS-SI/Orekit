...
class OrbitHermiteInterpolatorTest {
    ...
    void testCartesianInterpolationWithDerivatives() {
        doTestCartesianInterpolation(CartesianDerivativesFilter.USE_P,
                                     394, 0.1968, 3.21, 0.021630,
                                     2474, 2707.6418, 6.6, 26.28);

        doTestCartesianInterpolation(CartesianDerivativesFilter.USE_PV,
        ...
        doTestCartesianInterpolation(CartesianDerivativesFilter.USE_PVA,
    ...
    void testCircularInterpolationWithDerivatives() {
        doTestCircularInterpolation(397, 1.88e-8,
                                    610, 3.52e-6,
                                    4870, 115);
    }
    ...
    void testEquinoctialInterpolationWithDerivatives() {
        doTestEquinoctialInterpolation(397, 1.17e-8,
                                       610, 4.48e-6,
                                       4870, 115);
    }
    ...
    void testKeplerianInterpolationWithDerivatives() {
        doTestKeplerianInterpolation(397, 4.01, 4.75e-4, 1.28e-7,
                                     2159, 1.05e7, 1.19e-3, 0.773);
    }

    private void doTestCartesianInterpolation(CartesianDerivativesFilter pvaFilter,
    ...
    private void doTestCircularInterpolation(double shiftErrorWithin, double interpolationErrorWithin,
    ...
    private void doTestEquinoctialInterpolation(double shiftErrorWithin, double interpolationErrorWithin,
                                                double shiftErrorSlightlyPast, double interpolationErrorSlightlyPast,
                                                double shiftErrorFarPast, double interpolationErrorFarPast) {
    ...
    private void doTestKeplerianInterpolation(double shiftPositionErrorWithin, double interpolationPositionErrorWithin,
