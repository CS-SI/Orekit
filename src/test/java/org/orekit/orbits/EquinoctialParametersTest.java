...
class EquinoctialParametersTest {
    ...
    private void templateTestBackAndForthElliptical(final PositionAngleType initialType,
        ...
        // GIVEN
        final EquinoctialParameters expectedElements = new EquinoctialParameters(1., 0.5, 0.5, 0.5, 0.5, 0.5, initialType);
        // WHEN
        final EquinoctialParameters elements = expectedElements.withPositionAngleType(intermediateType);
        final EquinoctialParameters actualElements = elements.withPositionAngleType(initialType);
        // THEN
        ...
        assertEquals(expectedElements.longitudeArgument(), actualElements.longitudeArgument(), 1e-12);
    }
}
